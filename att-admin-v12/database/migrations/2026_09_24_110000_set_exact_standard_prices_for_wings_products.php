...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        foreach ($oldWsProducts as $oldProd) {
            // Update harga lama ke harga baru padanannya jika memungkinkan
        ...
        // Bersihkan relasi produk lama WS-MS yang tidak aktif dari template Wings
        ...
        // Hubungkan 36 produk aktif ini ke template pelaporan Wings
