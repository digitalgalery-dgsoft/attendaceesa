...
class EmployeeScheduleMatrixTemplateExport extends DefaultValueBinder implements FromArray, WithHeadings, WithStyles, ShouldAutoSize, WithCustomValueBinder
{
    ...
    public function array(): array
    {
        ...
        $sampleEmployees = $employeeQuery->limit(15)->get();

        $sampleShift = Shift::where('is_active', 1)->first();
        $sampleShiftCode = $sampleShift ? ($sampleShift->code ?: $sampleShift->name) : 'FLEKSIBEL01';
