    ...
    public static function syncDuluxMergedStockEnd(): void
    {
        ...
        if ($cbpTemplate) {
            ...
            $cbpFields = [
                ...
                ['field_label' => 'Nama Subbrand Kompetitor yang Dicek', 'field_name' => 'subbrand_kompetitor', 'field_type' => 'dropdown', 'placeholder' => 'Pilih Subbrand Kompetitor', 'options' => (class_exists(\App\Models\CompetitorProduct::class) && \Illuminate\Support\Facades\Schema::hasTable('competitor_products') ? \App\Models\CompetitorProduct::where('is_active', true)->pluck('subbrand')->unique()->values()->toArray() : []) ?: ['Majestic True Beauty Matt / Sheen', 'Jotashield Antifade Colours', 'Essence Cover Plus', 'Vinilex Regular (White & Color)', 'Spot-less (Anti Noda)', 'Weatherbond', 'Sunguard All-in-One', 'Supersilk Anti Noda', 'Avitex Interior', 'No Drop (Pelapis Anti Bocor)', 'Weathercoat Regular', 'Emulsion (Interior Premium)', 'Cendana Interior', 'Decorshield', 'Decorcryl', 'Eco Emulsion', 'Sincere', 'Ruby', 'Metrolite', 'LAINNYA / INPUT MANUAL'], 'is_required' => true],
