...
class PrincipalPortalController extends Controller
{
    ...
    public function storeReportTemplate(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'monthly_start_day' => 'nullable|integer|min:1|max:31',
            'monthly_end_day' => 'nullable|integer|min:1|max:31',
        ...
        $template = ReportTemplate::create([
            ...
            'monthly_due_day' => $validated['monthly_end_day'] ?? ($validated['monthly_due_day'] ?? null),
            'monthly_start_day' => $validated['monthly_start_day'] ?? null,
            'monthly_end_day' => $validated['monthly_end_day'] ?? ($validated['monthly_due_day'] ?? null),
