    ...
    <header class="hero">
        ...
        <div class="hero-cta-group">
            ...
            <a href="{{ $apkDownloadUrl }}" class="btn-primary-cta" target="_blank" rel="noopener noreferrer">
                ...
                <span style="font-size: 0.75rem; background: rgba(255,255,255,0.22); padding: 0.2rem 0.5rem; border-radius: 6px;">v1.0.111</span>
            </a>
        ...
        <div class="app-download-box">
            <div class="app-download-content">
                <span class="app-badge-version">
                    <i class="fa-brands fa-android"></i> Versi Rilis Terbaru v1.0.111
                </span>
