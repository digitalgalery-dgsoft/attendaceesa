        ...
        <ul class="navbar-nav flex-row align-items-center ms-auto">
          ...
          <li class="nav-item navbar-dropdown dropdown-user dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
              ...
              @if (Auth::check())
              <li>
                <a class="dropdown-item" href="{{ Route::has('logout') ? route('logout') : 'javascript:void(0)' }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                  <i class='ti ti-logout me-2'></i>
                  <span class="align-middle">Logout</span>
                </a>
              </li>
              <form method="POST" id="logout-form" action="{{ Route::has('logout') ? route('logout') : 'javascript:void(0)' }}">
                @csrf
              </form>
              @else
              <li>
