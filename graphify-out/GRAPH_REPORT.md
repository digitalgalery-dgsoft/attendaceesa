...
## Corpus Check
- Large corpus: 1432 files · ~4,638,193 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 13882 nodes · 33318 edges · 772 communities (274 shown, 498 thin omitted)
...
- Employee & Identity Management
- Admin Panel Filament Resources
- Subsystem: Maatwebsite\Excel\Concern
- Subsystem: match()
- Employee & Identity Management
- Reporting & Form Engine
- Odoo ERP & Principal Integration
...
2. `ReportTemplate` - 199 edges
3. `Principal` - 188 edges
...
## Communities (772 total, 498 thin omitted)
...
### Community 6 - "Subsystem: ReportTemplate"
Cohesion: 0.02
Nodes (76): ImportDuluxDailyMaintenanceCommand, ImportDuluxOosCommand, ImportDuluxStockCommand, {closure#2}(), {closure#1}(), {closure#1}(), {closure#1}(), {closure#1}() (+68 more)

### Community 7 - "Employee & Identity Management"
Cohesion: 0.01
Nodes (102): {closure#1}(), {closure#2}(), {closure#1}(), {closure#2}(), {closure#3}(), {closure#1}(), {closure#2}(), {closure#3}() (+94 more)

### Community 8 - "Admin Panel Filament Resources"
Cohesion: 0.01
Nodes (51): {closure#1}(), {closure#1}(), {closure#1}(), {closure#1}(), {closure#1}(), {closure#1}(), {closure#1}(), {closure#1}() (+43 more)
...
Cohesion: 0.01
Nodes (59): AiSettings, BackedEnum, UnitEnum, ManageSettings, BackedEnum, UnitEnum, {closure#1}(), {closure#3}() (+51 more)

### Community 11 - "Attendance & Schedule Subsystem"
Cohesion: 0.02
Nodes (70): AreaResource, AreaForm, AreasTable, AttendanceBapsTable, AttendanceResource, Builder, UnitEnum, AttendanceForm (+62 more)

### Community 12 - "Odoo ERP & Principal Integration"
Cohesion: 0.02
Nodes (45): CreateDuluxDummyEmployeesCommand, OdooSyncCommand, DashboardStatsWidget, ServerGatewayController, InstallController, {closure#1}(), OdooSyncStreamController, Company (+37 more)

### Community 13 - "API & Mobile State Providers"
Cohesion: 0.01
...
### Community 14 - "Employee & Identity Management"
Cohesion: 0.02
Nodes (38): LiveChat, BackedEnum, UnitEnum, Width, ChatController, ItineraryController, MeetingController, PayslipApiController (+30 more)

### Community 15 - "Attendance & Schedule Subsystem"
Cohesion: 0.02
Nodes (43): App\Filament\Resources\ExtraHourResource\Pages, App\Filament\Resources\PayslipResource\Pages, App\Filament\Resources\VisitReportResource\Pages, App\Filament\Resources\WorkingGroupResource\Pages, App\Filament\Resources\WorkTargetResource\Pages, {closure#1}(), {closure#2}(), {closure#3}() (+35 more)

### Community 16 - "Flutter Mobile UI Components"
Cohesion: 0.03
...
### Community 20 - "Subsystem: markdown-editor.js"
Cohesion: 0.04
Nodes (122): Aa(), Ac(), ad(), af(), ai(), An(), ao(), Ba() (+114 more)

### Community 21 - "Attendance & Schedule Subsystem"
Cohesion: 0.02
Nodes (20): {closure#20}(), {closure#5}(), {closure#10}(), AttendanceController, DashboardApiController, PermitController, TrackingController, AttendanceImport (+12 more)
...
Cohesion: 0.03
Nodes (34): SendMissedCheckinNotification, {closure#1}(), {closure#10}(), {closure#11}(), {closure#12}(), {closure#13}(), {closure#14}(), {closure#15}() (+26 more)
...
Cohesion: 0.03
Nodes (32): EditArea, EditAttendance, EditBlastInfo, EditBranch, EditCompany, EditCompetitorProduct, EditDepartment, EditEmployee (+24 more)

### Community 27 - "Subsystem: resolve()"
Cohesion: 0.07
Nodes (105): ad(), addKeyboardShortcuts(), after(), as(), Ay(), bc(), before(), between() (+97 more)

### Community 28 - "Odoo ERP & Principal Integration"
Cohesion: 0.05
Nodes (15): DashboardHeaderWidget, AuthController, TenantAuthController, Carbon, PrincipalPortalController, {closure#1}(), BelongsToMany, Product (+7 more)

### Community 29 - "Subsystem: W()"
Cohesion: 0.04
Nodes (104): aa(), aO(), atLastNode(), au(), b1(), Bg(), ch(), charCategorizer() (+96 more)

### Community 30 - "Subsystem: draw()"
Cohesion: 0.04
...
### Community 32 - "Subsystem: y()"
Cohesion: 0.10
Nodes (95): Dg(), Ig(), Se(), al(), at(), b(), Be(), $c() (+87 more)

### Community 33 - "Subsystem: ir()"
Cohesion: 0.05
Nodes (92): getExtension(), _getTestState(), We(), Ae(), ar(), Be(), Bt(), Ce() (+84 more)

### Community 34 - "Admin Panel Filament Resources"
Cohesion: 0.04
...
Cohesion: 0.08
Nodes (91): _a(), Ae(), ar(), as(), bc(), bf(), Bt(), ee() (+83 more)

### Community 37 - "Attendance & Schedule Subsystem"
Cohesion: 0.03
Nodes (30): {closure#11}(), {closure#12}(), {closure#14}(), {closure#15}(), {closure#16}(), {closure#19}(), {closure#2}(), {closure#23}() (+22 more)
...
### Community 43 - "Subsystem: constructor()"
Cohesion: 0.04
Nodes (83): $a(), alpha(), apply(), Bc(), bg(), ca(), chartOptionScopes(), Ci() (+75 more)

### Community 44 - "Attendance & Schedule Subsystem"
Cohesion: 0.04
Nodes (27): ListAreas, ListAttendanceBaps, ListAttendances, ListBlastInfos, ListBranches, ListCompanies, ListCompetitorProducts, ListDepartments (+19 more)

### Community 45 - "Subsystem: step()"
Cohesion: 0.05
Nodes (80): addNodeMark(), allowedMarks(), am(), append(), au(), clearIncompatible(), close(), closeFrontierNode() (+72 more)

### Community 46 - "Subsystem: WorkLocation"
Cohesion: 0.04
Nodes (22): FixEmptyLocationCodesCommand, ImportDuluxAmkStoresCommand, ImportInhouseStoresCommand, CreateWorkingGroup, EditWorkingGroup, {closure#147}(), {closure#148}(), {closure#150}() (+14 more)

### Community 47 - "Subsystem: s()"
Cohesion: 0.04
Nodes (79): Eo(), ac(), addEventListener(), al(), average(), bindResponsiveEvents(), bs(), cc() (+71 more)

### Community 48 - "Employee & Identity Management"
Cohesion: 0.03
Nodes (42): {closure#2}(), {closure#1}(), {closure#2}(), {closure#3}(), {closure#4}(), {closure#5}(), {closure#6}(), ListEmployees (+34 more)
...
Cohesion: 0.05
Nodes (55): am(), Ap(), be(), bi(), Bp(), c(), clickPercent(), cm() (+47 more)

### Community 53 - "Subsystem: dependencies"
Cohesion: 0.03
Nodes (72): dependencies, animate.css, aos, apexcharts-clevision, autosize, block-ui, bloodhound-js, bootstrap (+64 more)

### Community 54 - "Subsystem: __fire()"
Cohesion: 0.05
...
### Community 59 - "Flutter Mobile UI Components"
Cohesion: 0.03
...
Cohesion: 0.04
Nodes (29): CreateArea, CreateAttendance, CreateBlastInfo, CreateBranch, CreateCompany, CompetitorProductResource, UnitEnum, CreateCompetitorProduct (+21 more)

### Community 61 - "Subsystem: push()"
Cohesion: 0.08
Nodes (63): _a(), addInitHooks(), a(), c(), h(), o(), p(), r() (+55 more)

### Community 62 - "Attendance & Schedule Subsystem"
Cohesion: 0.04
Nodes (19): Login, EmployeeForm, ListEmployeeSchedules, ItineraryResource, Builder, UnitEnum, CreateItinerary, ListItineraries (+11 more)
...
### Community 64 - "Flutter Mobile UI Components"
Cohesion: 0.04
Nodes (25): App\Filament\Resources\BlastInfoResource\Pages, App\Filament\Resources\LeaveRequestResource\Pages, BlastInfoResource, {closure#3}(), {closure#4}(), Schema, UnitEnum, {closure#1}() (+17 more)

### Community 65 - "Attendance & Schedule Subsystem"
Cohesion: 0.04
Nodes (18): AttendanceBapResource, UnitEnum, CreateAttendanceBap, EditAttendanceBap, ViewAttendanceBap, AttendanceBapForm, ViewLeaveRequest, ViewLocationRequest (+10 more)
...
### Community 67 - "Reporting & Form Engine"
Cohesion: 0.03
...
### Community 68 - "Admin Panel Filament Resources"
Cohesion: 0.06
...
### Community 70 - "Subsystem: te()"
Cohesion: 0.04
Nodes (10): Ud(), Bi(), Bn(), br(), Id(), ji(), qd(), qi() (+2 more)
...
### Community 72 - "Subsystem: getContext()"
Cohesion: 0.06
...
### Community 74 - "Reporting & Form Engine"
Cohesion: 0.04
...
### Community 79 - "Subsystem: columns/select.js"
Cohesion: 0.08
Nodes (43): Ae(), Ai(), An(), applyDisabledState(), be(), Bt(), De(), disable() (+35 more)

### Community 80 - "Subsystem: draw()"
Cohesion: 0.07
...
### Community 82 - "API & Mobile State Providers"
Cohesion: 0.06
Nodes (52): aa(), As(), Ba(), buildOrUpdateControllers(), buildOrUpdateElements(), cd(), _dataCheck(), _destroy() (+44 more)

### Community 83 - "Attendance & Schedule Subsystem"
Cohesion: 0.05
Nodes (10): ViewTrackingHistory, EmployeeScheduleRoster, MeetingResource, UnitEnum, CreateMeeting, EditMeeting, ViewMeeting, {closure#1}() (+2 more)
...
### Community 85 - "Employee & Identity Management"
Cohesion: 0.04
...
### Community 86 - "Odoo ERP & Principal Integration"
Cohesion: 0.07
...
### Community 100 - "Attendance & Schedule Subsystem"
Cohesion: 0.07
...
### Community 101 - "Visit & Itinerary Management"
Cohesion: 0.05
...
### Community 113 - "Subsystem: Pe()"
Cohesion: 0.10
Nodes (39): cd(), Cr(), dd(), dt(), Fr(), Ft(), gl(), Gt() (+31 more)
...
Cohesion: 0.09
Nodes (13): AttendanceRosterMatrixExport, EmployeeScheduleMatrixTemplateExport, EmployeeScheduleRangeTemplateExport, EmployeeScheduleTemplateExport, ShiftTemplateExport, VisitScheduleTemplateExport, {closure#13}(), {closure#8}() (+5 more)

### Community 122 - "API & Mobile State Providers"
Cohesion: 0.06
...
### Community 131 - "Employee & Identity Management"
Cohesion: 0.06
...
### Community 136 - "Subsystem: get()"
Cohesion: 0.09
Nodes (31): active(), add(), _animateOptions(), bo(), bs(), _cachedScopes(), Ch(), _createAnimations() (+23 more)

### Community 137 - "Attendance & Schedule Subsystem"
Cohesion: 0.12
Nodes (14): AttendanceImportTemplateExport, {closure#6}(), {closure#11}(), Maatwebsite\Excel\Concerns\ShouldAutoSize, Maatwebsite\Excel\Concerns\WithColumnFormatting, PhpOffice\PhpSpreadsheet\Cell\Coordinate, PhpOffice\PhpSpreadsheet\Cell\DataType, PhpOffice\PhpSpreadsheet\Spreadsheet (+6 more)

### Community 138 - "Reporting & Form Engine"
Cohesion: 0.35
...
### Community 139 - "Subsystem: _a()"
Cohesion: 0.18
Nodes (30): _a(), aa(), ba(), br(), Bt(), ct(), Da(), ei() (+22 more)

### Community 140 - "Reporting & Form Engine"
Cohesion: 0.08
...
### Community 142 - "Attendance & Schedule Subsystem"
Cohesion: 0.10
...
### Community 145 - "Subsystem: TeamUncheckedMonitoring"
Cohesion: 0.09
...
### Community 148 - "Subsystem: Maatwebsite\Excel\Concern"
Cohesion: 0.11
Nodes (6): MandaysExport, ManPowerExport, TeamUncheckedExport, TurnOverExport, Maatwebsite\Excel\Concerns\FromArray, Maatwebsite\Excel\Concerns\WithHeadings

### Community 149 - "Subsystem: match()"
Cohesion: 0.12
...
### Community 151 - "Reporting & Form Engine"
Cohesion: 0.09
...
### Community 152 - "Odoo ERP & Principal Integration"
Cohesion: 0.10
...
Cohesion: 0.11
Nodes (7): ReportSubmissionValue, up(), {closure#2}(), up(), up(), up(), up()
...
Cohesion: 0.10
Nodes (4): App\Http\Controllers\Api\EmployeeController, BlastInfoController, NotificationController, GET /user()
...
### Community 159 - "Reporting & Form Engine"
Cohesion: 0.13
Nodes (5): OdooSyncReport, BackedEnum, UnitEnum, Width, OdooSyncLog

### Community 160 - "Attendance & Schedule Subsystem"
Cohesion: 0.17
Nodes (6): AttendanceChartWidget, Filament\Actions\Concerns\InteractsWithActions, Filament\Actions\Contracts\HasActions, Filament\Schemas\Concerns\InteractsWithSchemas, Filament\Schemas\Contracts\HasSchemas, Filament\Widgets\ChartWidget\Concerns\HasFiltersSchema
...
### Community 164 - "Subsystem: fn()"
Cohesion: 0.21
Nodes (18): Ae(), An(), Ce(), De(), fn(), Ft(), ht(), ii() (+10 more)

### Community 165 - "Odoo ERP & Principal Integration"
Cohesion: 0.11
...
### Community 169 - "API & Mobile State Providers"
Cohesion: 0.12
...
Cohesion: 0.14
Nodes (3): MandaysChartWidget, ManPowerChartWidget, Filament\Widgets\ChartWidget

### Community 172 - "Attendance & Schedule Subsystem"
Cohesion: 0.15
...
### Community 173 - "Subsystem: t()"
Cohesion: 0.14
Nodes (15): b(), di(), e(), g(), Ht(), i(), Ie(), Me() (+7 more)

### Community 174 - "Subsystem: color-picker.js"
Cohesion: 0.13
...
### Community 176 - "Subsystem: TestCase"
Cohesion: 0.16
...
### Community 178 - "Attendance & Schedule Subsystem"
Cohesion: 0.23
...
### Community 179 - "API & Mobile State Providers"
Cohesion: 0.13
...
### Community 180 - "Admin Panel Filament Resources"
Cohesion: 0.14
Nodes (6): html_parser, HTMLParser, SimpleParser, json, urllib_parse, urllib_request

### Community 181 - "Subsystem: .prettierrc.json"
Cohesion: 0.13
...
### Community 182 - "Flutter Mobile UI Components"
Cohesion: 0.19
...
### Community 187 - "Flutter Mobile UI Components"
Cohesion: 0.28
...
### Community 188 - "Subsystem: renderOptions()"
Cohesion: 0.37
...
### Community 189 - "Subsystem: e()"
Cohesion: 0.21
Nodes (13): A(), e(), ue(), vi(), c(), X(), a(), toggleFiltersDropdown() (+5 more)

### Community 190 - "Employee & Identity Management"
Cohesion: 0.15
...
### Community 192 - "Admin Panel Filament Resources"
Cohesion: 0.17
Nodes (11): autoload-dev, psr-4, description, keywords, license, minimum-stability, name, prefer-stable (+3 more)

### Community 193 - "Subsystem: date-time-picker.js"
Cohesion: 0.29
Nodes (7): d(), e(), i(), m(), r(), s(), t()

### Community 196 - "Admin Panel Filament Resources"
Cohesion: 0.17
...
### Community 197 - "Subsystem: Doc: SKILL.md"
Cohesion: 0.17
...
### Community 199 - "Reporting & Form Engine"
Cohesion: 0.17
...
### Community 200 - "Subsystem: _calcLatLngDistances()"
Cohesion: 0.20
...
### Community 205 - "Attendance & Schedule Subsystem"
Cohesion: 0.18
...
### Community 214 - "Reporting & Form Engine"
Cohesion: 0.20
...
### Community 215 - "Flutter Mobile UI Components"
Cohesion: 0.22
...
### Community 222 - "Admin Panel Filament Resources"
Cohesion: 0.22
...
### Community 224 - "Subsystem: require-dev"
Cohesion: 0.25
Nodes (8): require-dev, fakerphp/faker, laravel/pail, laravel/pao, laravel/pint, mockery/mockery, nunomaduro/collision, phpunit/phpunit

### Community 225 - "Subsystem: X()"
Cohesion: 0.29
Nodes (8): A(), e(), Q(), ue(), vi(), c(), w(), X()

### Community 226 - "Attendance & Schedule Subsystem"
Cohesion: 0.25
...
### Community 241 - "Admin Panel Filament Resources"
Cohesion: 0.29
...
### Community 242 - "Subsystem: Doc: implementation-playb"
Cohesion: 0.29
...
### Community 245 - "Attendance & Schedule Subsystem"
Cohesion: 0.29
...
### Community 246 - "Odoo ERP & Principal Integration"
Cohesion: 0.29
...
### Community 251 - "Employee & Identity Management"
Cohesion: 0.60
...
### Community 300 - "Subsystem: horizontalLayout.blade.ph"
Cohesion: 0.40
...
### Community 302 - "Subsystem: deploy.sh"
Cohesion: 0.70
Nodes (4): deploy_local_dev(), deploy_three_prod_servers(), setup_ssh_pairing(), deploy.sh script

### Community 303 - "Attendance & Schedule Subsystem"
Cohesion: 0.40
...
### Community 313 - "Attendance & Schedule Subsystem"
Cohesion: 0.50
Nodes (3): mountAction(, nextPage({{ $pagination[, previousPage

### Community 318 - "Subsystem: app-calendar-events.js"
Cohesion: 0.50
Nodes (3): date, events, nextDay

### Community 319 - "Reporting & Form Engine"
Cohesion: 0.50
Nodes (3): assetsPath, config, templateName

### Community 321 - "Subsystem: app-invoice-edit.blade.ph"
Cohesion: 0.50
...
### Community 327 - "Reporting & Form Engine"
Cohesion: 0.50
...
### Community 329 - "Subsystem: extra"
Cohesion: 0.67
Nodes (3): extra, laravel, dont-discover

### Community 330 - "Subsystem: pt()"
Cohesion: 0.67
Nodes (3): H(), ji(), pt()

### Community 347 - "Subsystem: Doc: implementation-playb"
Cohesion: 0.67
Nodes (3): Doc: implementation-playbook.md, Dependency Audit and Security Analysis Implementat, Instructions

### Community 348 - "Subsystem: Doc: README.md"
Cohesion: 0.67
Nodes (3): Doc: README.md, Getting Started, att_mobile

### Community 349 - "Attendance & Schedule Subsystem"
Cohesion: 0.67
...
- **2127 isolated node(s):** `SortDirection`, `$schema`, `name`, `type`, `description` (+2122 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 5369 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **498 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `BlastInfo` connect `Employee & Identity Management` to `Flutter Mobile UI Components`, `Attendance & Schedule Subsystem`, `Employee & Identity Management`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `Controller` connect `Employee & Identity Management` to `Odoo ERP & Principal Integration`, `Attendance & Schedule Subsystem`, `Employee & Identity Management`, `Odoo ERP & Principal Integration`, `API & Mobile State Providers`, `Employee & Identity Management`, `Attendance & Schedule Subsystem`, `Attendance & Schedule Subsystem`, `Attendance & Schedule Subsystem`, `Employee & Identity Management`, `Reporting & Form Engine`, `Odoo ERP & Principal Integration`, `Employee & Identity Management`, `Attendance & Schedule Subsystem`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `Principal` connect `Subsystem: ReportTemplate` to `Employee & Identity Management`, `Odoo ERP & Principal Integration`, `Attendance & Schedule Subsystem`, `Admin Panel Filament Resources`, `Attendance & Schedule Subsystem`, `Odoo ERP & Principal Integration`, `Employee & Identity Management`, `Attendance & Schedule Subsystem`, `Attendance & Schedule Subsystem`, `Reporting & Form Engine`, `Attendance & Schedule Subsystem`, `Attendance & Schedule Subsystem`, `Reporting & Form Engine`, `Odoo ERP & Principal Integration`, `Odoo ERP & Principal Integration`, `Attendance & Schedule Subsystem`, `Attendance & Schedule Subsystem`, `Attendance & Schedule Subsystem`, `Subsystem: WorkLocation`, `Employee & Identity Management`, `Odoo ERP & Principal Integration`, `Attendance & Schedule Subsystem`, `API & Mobile State Providers`, `Attendance & Schedule Subsystem`, `Odoo ERP & Principal Integration`, `Employee & Identity Management`, `Reporting & Form Engine`, `Attendance & Schedule Subsystem`, `Odoo ERP & Principal Integration`, `Odoo ERP & Principal Integration`, `Attendance & Schedule Subsystem`?**
