...
## Corpus Check
- Large corpus: 1433 files · ~4,640,196 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 13894 nodes · 33343 edges · 776 communities (278 shown, 498 thin omitted)
...
- Subsystem: HelpCenterLanding.php
- Subsystem: MiscUnderMaintenance.php
- Employee & Identity Management
- Admin Panel Filament Resources
- Admin Panel Filament Resources
- Admin Panel Filament Resources
- Subsystem: Alerts.php
- Subsystem: ListGroups.php
- Subsystem: Modals.php
- Subsystem: Spinners.php
...
- `InvoiceEdit` --inherits--> `Controller`  [EXTRACTED]
  att-admindashboard/app/Http/Controllers/apps/InvoiceEdit.php → att-admin-v12/app/Http/Controllers/Controller.php

## Import Cycles
- None detected.

## Communities (776 total, 498 thin omitted)

### Community 0 - "Employee & Identity Management"
Cohesion: 0.01
Nodes (233): {closure#1}(), {closure#2}(), {closure#3}(), {closure#1}(), {closure#2}(), {closure#1}(), {closure#2}(), {closure#3}() (+225 more)

### Community 1 - "Subsystem: rich-editor.js"
Cohesion: 0.01
Nodes (189): $0(), Ab(), ac(), addHackNode(), addOptions(), addTextblockHacks(), ag(), An() (+181 more)

### Community 2 - "Odoo ERP & Principal Integration"
Cohesion: 0.02
Nodes (87): CheckDuluxProductsCommand, CheckPrincipalsCommand, CleanDuluxWorkLocationsCommand, ImportAreasCommand, ImportDuluxCbpCommand, ImportDuluxDailyMaintenanceCommand, ImportDuluxOfftakeCommand, ImportDuluxOosCommand (+79 more)
...
### Community 4 - "API & Mobile State Providers"
Cohesion: 0.01
Nodes (84): Controller, AccessPermission, Calendar, Chat, Email, InvoiceAdd, InvoicePreview, InvoicePrint (+76 more)

### Community 5 - "Subsystem: components/chart.js"
Cohesion: 0.01
...
Cohesion: 0.02
Nodes (77): AreaForm, AreasTable, AttendanceBapForm, AttendanceResource, Builder, UnitEnum, AttendancesTable, BranchForm (+69 more)
...
Cohesion: 0.02
Nodes (57): SendMissedCheckinNotification, EmployeeScheduleTemplateExport, Login, Dashboard, {closure#1}(), {closure#2}(), {closure#3}(), {closure#4}() (+49 more)

### Community 11 - "API & Mobile State Providers"
Cohesion: 0.01
...
Cohesion: 0.02
Nodes (36): CreateItinerary, {closure#1}(), {closure#6}(), {closure#9}(), BlastInfo, CompetitorProduct, Holiday, ItineraryItem (+28 more)

### Community 13 - "Flutter Mobile UI Components"
Cohesion: 0.03
Nodes (159): _a(), addAttributes(), addGlobalAttributes(), addNodeView(), addProseMirrorPlugins(), af(), c(), d() (+151 more)

### Community 14 - "Admin Panel Filament Resources"
Cohesion: 0.02
Nodes (49): AiSettings, BackedEnum, UnitEnum, {closure#1}(), {closure#2}(), ManageSettings, BackedEnum, UnitEnum (+41 more)

### Community 15 - "Attendance & Schedule Subsystem"
Cohesion: 0.02
Nodes (59): {closure#1}(), {closure#2}(), {closure#2}(), CompetitorProductForm, {closure#3}(), {closure#1}(), {closure#10}(), {closure#9}() (+51 more)
...
### Community 17 - "Attendance & Schedule Subsystem"
Cohesion: 0.02
Nodes (35): {closure#1}(), {closure#2}(), {closure#20}(), {closure#3}(), {closure#5}(), {closure#7}(), {closure#8}(), {closure#10}() (+27 more)

### Community 18 - "API & Mobile State Providers"
Cohesion: 0.02
Nodes (99): acquireContext(), addControllers(), addPlugins(), addScales(), as(), bl(), bo(), br() (+91 more)

### Community 19 - "Employee & Identity Management"
Cohesion: 0.02
Nodes (44): CreateDuluxDummyEmployeesCommand, FixEmptyLocationCodesCommand, ImportDuluxAmkStoresCommand, ImportInhouseStoresCommand, OdooSyncCommand, {closure#15}(), {closure#2}(), {closure#7}() (+36 more)

### Community 20 - "Subsystem: constructor()"
Cohesion: 0.03
Nodes (133): add(), addChunk(), addEventListener(), addInfoPane(), addInner(), addWindowListeners(), adjust(), annotation() (+125 more)

### Community 21 - "Subsystem: markdown-editor.js"
Cohesion: 0.04
Nodes (112): Ac(), ad(), af(), ai(), An(), ao(), Ba(), bl() (+104 more)

### Community 22 - "Flutter Mobile UI Components"
Cohesion: 0.03
...
Cohesion: 0.04
Nodes (29): App\Filament\Resources\PayslipResource\Pages, App\Filament\Resources\VisitReportResource\Pages, App\Filament\Resources\WorkingGroupResource\Pages, App\Filament\Resources\WorkTargetResource\Pages, AttendanceForm, {closure#1}(), {closure#12}(), {closure#14}() (+21 more)

### Community 25 - "Subsystem: draw()"
Cohesion: 0.04
Nodes (107): acquireContext(), adjustHitBoxes(), Ao(), aspectRatio(), B(), bh(), calculateLabelRotation(), _calculatePadding() (+99 more)

### Community 26 - "Subsystem: resolve()"
Cohesion: 0.07
Nodes (105): ad(), addKeyboardShortcuts(), after(), as(), Ay(), bc(), before(), between() (+97 more)
...
Cohesion: 0.03
Nodes (31): EditArea, EditAttendanceBap, EditAttendance, EditBlastInfo, EditCompany, EditCompetitorProduct, EditDepartment, EditEmployee (+23 more)
...
Cohesion: 0.06
Nodes (14): ExtraHourController, PayslipApiController, ServerGatewayController, TenantAuthController, OdooSyncStreamController, Carbon, PrincipalPortalController, Setting (+6 more)

### Community 31 - "Admin Panel Filament Resources"
Cohesion: 0.04
Nodes (98): Fe(), ac(), ae(), after(), ag(), Al(), Am(), before() (+90 more)

### Community 32 - "API & Mobile State Providers"
Cohesion: 0.04
...
Cohesion: 0.03
Nodes (41): {closure#2}(), {closure#3}(), {closure#4}(), {closure#5}(), {closure#6}(), {closure#7}(), {closure#9}(), BranchResource (+33 more)

### Community 35 - "Employee & Identity Management"
Cohesion: 0.04
Nodes (87): acceptToken(), addChild(), addGaps(), addLeafElement(), addNode(), advance(), allows(), ATXHeading() (+79 more)

### Community 36 - "Subsystem: n()"
Cohesion: 0.08
Nodes (84): Ae(), ar(), as(), at(), bf(), u(), ci(), cl() (+76 more)

### Community 37 - "Attendance & Schedule Subsystem"
Cohesion: 0.03
...
### Community 38 - "Subsystem: e()"
Cohesion: 0.07
Nodes (84): addCommands(), ak(), allowsMarks(), Ap(), apply(), bk(), bm(), bp() (+76 more)

### Community 39 - "Subsystem: t()"
Cohesion: 0.04
Nodes (84): Ai(), ao(), Ar(), as(), Ba(), bi(), bn(), ci() (+76 more)

### Community 40 - "Attendance & Schedule Subsystem"
Cohesion: 0.04
Nodes (28): ListAreas, ListAttendanceBaps, ListAttendances, ListBlastInfos, ListBranches, ListCompanies, ListCompetitorProducts, ListDepartments (+20 more)

### Community 41 - "Subsystem: step()"
Cohesion: 0.05
Nodes (80): addNodeMark(), allowedMarks(), am(), append(), au(), clearIncompatible(), close(), closeFrontierNode() (+72 more)

### Community 42 - "Attendance & Schedule Subsystem"
Cohesion: 0.03
Nodes (32): AreaResource, CreateArea, CreateAttendance, CreateBlastInfo, CreateCompany, CompetitorProductResource, UnitEnum, CreateCompetitorProduct (+24 more)

### Community 43 - "Subsystem: s()"
Cohesion: 0.04
...
Cohesion: 0.03
Nodes (13): DbLocksCommand, FixOrphanedEmployeeDataCommand, {closure#1}(), {closure#3}(), up(), {closure#1}(), {closure#3}(), {closure#1}() (+5 more)

### Community 46 - "Subsystem: i()"
Cohesion: 0.04
...
### Community 50 - "Subsystem: _update()"
Cohesion: 0.05
...
### Community 51 - "Visit & Itinerary Management"
Cohesion: 0.03
...
Cohesion: 0.06
Nodes (21): AttendanceImportTemplateExport, AttendanceRosterMatrixExport, EmployeeScheduleMatrixTemplateExport, EmployeeScheduleRangeTemplateExport, MandaysExport, ManPowerExport, ShiftTemplateExport, TeamUncheckedExport (+13 more)

### Community 53 - "Subsystem: file-upload.js"
Cohesion: 0.05
Nodes (50): am(), Ap(), be(), bi(), Bp(), c(), clickPercent(), cm() (+42 more)

### Community 54 - "Subsystem: support.js"
Cohesion: 0.05
Nodes (51): apply(), as(), At(), bo(), bs(), close(), closeQuietly(), co() (+43 more)

### Community 55 - "Subsystem: y()"
Cohesion: 0.12
...
### Community 64 - "Subsystem: updateElements()"
Cohesion: 0.05
...
### Community 65 - "Flutter Mobile UI Components"
Cohesion: 0.04
...
### Community 66 - "Flutter Mobile UI Components"
Cohesion: 0.04
...
### Community 70 - "Subsystem: O()"
Cohesion: 0.15
Nodes (46): Aa(), b(), $c(), X(), me(), D(), _e(), se() (+38 more)

### Community 71 - "Subsystem: enable()"
Cohesion: 0.07
Nodes (54): add(), _addDrawnLayerProp(), i(), _applyFocus(), _autoResize(), _cleanupSnapping(), _createHintLine(), _createMarker() (+46 more)

### Community 72 - "Subsystem: ir()"
Cohesion: 0.09
Nodes (52): [g](), ar(), De(), Ft(), ir(), at(), be(), ce() (+44 more)

### Community 73 - "Subsystem: ar()"
Cohesion: 0.05
Nodes (54): ar(), average(), beforeDatasetDraw(), beforeDatasetsDraw(), beforeDraw(), beforeLayout(), bi(), bu() (+46 more)

### Community 74 - "Subsystem: eq()"
Cohesion: 0.07
Nodes (51): addAll(), addDOM(), addElement(), addElementByRule(), addStoredMark(), addTextNode(), addToSet(), allowsMarkType() (+43 more)
...
Cohesion: 0.05
Nodes (14): AttendanceBapResource, UnitEnum, CreateAttendanceBap, ViewAttendanceBap, AttendanceBapsTable, ViewLeaveRequest, LocationRequestResource, Builder (+6 more)

### Community 80 - "Reporting & Form Engine"
Cohesion: 0.07
Nodes (10): BapApiController, LocationRequestApiController, ReportingApiController, SettingSyncController, TemplateSyncController, {closure#1}(), ReportSubmission, GoogleMapsService (+2 more)
...
### Community 84 - "Odoo ERP & Principal Integration"
Cohesion: 0.07
...
### Community 94 - "Subsystem: constructor()"
Cohesion: 0.06
Nodes (47): add(), addExtensions(), applyInitialSize(), Bn(), Cc(), configure(), constructor(), createCommandManager() (+39 more)

### Community 95 - "Subsystem: reduce()"
Cohesion: 0.08
Nodes (46): addActions(), advanceFully(), advanceStack(), allActions(), c0(), canShift(), close(), deadEnd() (+38 more)

### Community 96 - "Subsystem: of()"
Cohesion: 0.05
...
Cohesion: 0.05
Nodes (6): ViewTrackingHistory, ViewMeeting, CreateWorkingGroup, EditWorkingGroup, Filament\Resources\Pages\Concerns\InteractsWithRecord, Filament\Resources\Pages\Page

### Community 99 - "Subsystem: lP()"
Cohesion: 0.07
Nodes (45): addElement(), addToSet(), changeByRange(), changes(), childString(), dd(), fd(), ff() (+37 more)

### Community 100 - "Subsystem: get()"
Cohesion: 0.06
...
### Community 102 - "Visit & Itinerary Management"
Cohesion: 0.05
...
### Community 103 - "Odoo ERP & Principal Integration"
Cohesion: 0.08
Nodes (11): {closure#3}(), User, up(), UserManagement, User, Filament\Models\Contracts\FilamentUser, Illuminate\Contracts\Auth\MustVerifyEmail, Illuminate\Foundation\Auth\User (+3 more)
...
### Community 105 - "Admin Panel Filament Resources"
Cohesion: 0.08
...
### Community 113 - "Subsystem: d()"
Cohesion: 0.14
Nodes (36): Ai(), ar(), c(), d(), destroy(), Do(), f(), Fa() (+28 more)

### Community 114 - "Subsystem: Cn()"
Cohesion: 0.16
Nodes (36): Cn(), b(), Ce(), De(), dn(), _e(), F(), Fe() (+28 more)

### Community 115 - "API & Mobile State Providers"
Cohesion: 0.07
Nodes (9): {closure#5}(), PermitController, SalesPipelineController, SalesReportController, EmployeeLeaveQuota, SalesPipeline, SalesReport, AIService (+1 more)
...
### Community 133 - "Subsystem: components/select.js"
Cohesion: 0.11
Nodes (21): b(), be(), bn(), Bt(), ei(), en(), gt(), jn() (+13 more)

### Community 134 - "Subsystem: fn()"
Cohesion: 0.14
Nodes (31): ca(), Cr(), Dn(), e(), fn(), x(), Gi(), ia() (+23 more)

### Community 135 - "Attendance & Schedule Subsystem"
Cohesion: 0.10
Nodes (7): ActiveEmployeesHourlyChartWidget, AttendanceChartWidget, Filament\Actions\Concerns\InteractsWithActions, Filament\Actions\Contracts\HasActions, Filament\Schemas\Concerns\InteractsWithSchemas, Filament\Schemas\Contracts\HasSchemas, Filament\Widgets\ChartWidget\Concerns\HasFiltersSchema

### Community 136 - "Reporting & Form Engine"
Cohesion: 0.35
...
### Community 137 - "Subsystem: _a()"
Cohesion: 0.18
Nodes (30): _a(), aa(), ba(), br(), Bt(), ct(), Da(), ei() (+22 more)

### Community 138 - "Employee & Identity Management"
Cohesion: 0.07
Nodes (4): {closure#4}(), GET /admin/impersonate-start/{user}(), GET /admin/impersonate/{user}(), User
...
### Community 140 - "Odoo ERP & Principal Integration"
Cohesion: 0.08
...
### Community 141 - "API & Mobile State Providers"
Cohesion: 0.09
...
Cohesion: 0.13
Nodes (13): DashboardHeaderWidget, Carbon\Carbon, Filament\Widgets\Widget, Maatwebsite\Excel\Concerns\WithColumnFormatting, PhpOffice\PhpSpreadsheet\Cell\Coordinate, PhpOffice\PhpSpreadsheet\Cell\DataType, PhpOffice\PhpSpreadsheet\Spreadsheet, PhpOffice\PhpSpreadsheet\Style\Alignment (+5 more)
...
### Community 148 - "Reporting & Form Engine"
Cohesion: 0.10
Nodes (5): OdooSyncReport, BackedEnum, UnitEnum, {closure#1}(), OdooSyncLog

### Community 149 - "Flutter Mobile UI Components"
Cohesion: 0.10
Nodes (4): {closure#1}(), BackedEnum, UnitEnum, TeamUncheckedMonitoring

### Community 150 - "Flutter Mobile UI Components"
Cohesion: 0.09
Nodes (4): MandaysChartWidget, ManPowerChartWidget, TurnOverChartWidget, Filament\Widgets\ChartWidget

### Community 151 - "Subsystem: match()"
Cohesion: 0.12
...
### Community 153 - "Subsystem: octane.php"
Cohesion: 0.09
...
Cohesion: 0.12
Nodes (8): ListReportSubmissions, {closure#1}(), {closure#3}(), ViewReportSubmission, Builder, UnitEnum, ReportSubmissionResource, ReportSubmissionsTable

### Community 158 - "Subsystem: ye()"
Cohesion: 0.18
Nodes (21): cd(), ee(), ue(), Et(), fd(), _i(), lr(), od() (+13 more)

### Community 159 - "Visit & Itinerary Management"
Cohesion: 0.13
...
### Community 160 - "Subsystem: ResetPasswordMail"
Cohesion: 0.14
Nodes (10): ResetPasswordMail, PermitStatusUpdated, Illuminate\Bus\Queueable, Illuminate\Contracts\Queue\ShouldQueue, Illuminate\Mail\Mailable, Illuminate\Mail\Mailables\Attachment, Illuminate\Mail\Mailables\Content, Illuminate\Mail\Mailables\Envelope (+2 more)

### Community 161 - "Odoo ERP & Principal Integration"
Cohesion: 0.11
...
Cohesion: 0.21
Nodes (18): Ae(), An(), Ce(), De(), fn(), Ft(), ht(), ii() (+10 more)

### Community 167 - "Odoo ERP & Principal Integration"
Cohesion: 0.11
...
### Community 168 - "Employee & Identity Management"
Cohesion: 0.14
Nodes (7): {closure#1}(), PermissionMatrix, UnitEnum, RoleResource, RoleForm, RolesTable, Filament\Forms\Components\Field
...
### Community 174 - "Attendance & Schedule Subsystem"
Cohesion: 0.15
...
### Community 176 - "Admin Panel Filament Resources"
Cohesion: 0.17
...
### Community 177 - "Subsystem: TestCase"
Cohesion: 0.16
...
### Community 179 - "Attendance & Schedule Subsystem"
Cohesion: 0.23
...
### Community 180 - "API & Mobile State Providers"
Cohesion: 0.13
...
### Community 181 - "Subsystem: color-picker.js"
Cohesion: 0.14
Nodes (3): style(), update(), [x]()

### Community 182 - "Admin Panel Filament Resources"
Cohesion: 0.14
Nodes (6): html_parser, HTMLParser, SimpleParser, json, urllib_parse, urllib_request

### Community 183 - "Subsystem: .prettierrc.json"
Cohesion: 0.13
...
### Community 185 - "Attendance & Schedule Subsystem"
Cohesion: 0.14
...
### Community 187 - "Reporting & Form Engine"
Cohesion: 0.35
...
### Community 201 - "Subsystem: _calcLatLngDistances()"
Cohesion: 0.20
...
### Community 204 - "Subsystem: Doc: SKILL.md"
Cohesion: 0.18
...
### Community 206 - "Attendance & Schedule Subsystem"
Cohesion: 0.18
...
### Community 237 - "API & Mobile State Providers"
Cohesion: 0.29
...
### Community 243 - "Admin Panel Filament Resources"
Cohesion: 0.29
...
### Community 244 - "Subsystem: Doc: implementation-playb"
Cohesion: 0.29
...
### Community 246 - "Subsystem: Doc: SKILL.md"
Cohesion: 0.29
...
### Community 247 - "Attendance & Schedule Subsystem"
Cohesion: 0.29
...
### Community 249 - "Employee & Identity Management"
Cohesion: 0.53
...
### Community 250 - "Subsystem: att-admin-v12/config/logg"
Cohesion: 0.47
Nodes (4): Monolog\Handler\NullHandler, Monolog\Handler\StreamHandler, Monolog\Handler\SyslogUdpHandler, Monolog\Processor\PsrLogMessageProcessor

### Community 252 - "Attendance & Schedule Subsystem"
Cohesion: 0.47
...
- **2127 isolated node(s):** `SortDirection`, `$schema`, `name`, `type`, `description` (+2122 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 5379 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **498 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `BlastInfo` connect `Attendance & Schedule Subsystem` to `Visit & Itinerary Management`, `Attendance & Schedule Subsystem`, `Flutter Mobile UI Components`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `Controller` connect `API & Mobile State Providers` to `Odoo ERP & Principal Integration`, `Attendance & Schedule Subsystem`, `Attendance & Schedule Subsystem`, `Attendance & Schedule Subsystem`, `Attendance & Schedule Subsystem`, `API & Mobile State Providers`, `Employee & Identity Management`, `Employee & Identity Management`, `Visit & Itinerary Management`, `Employee & Identity Management`, `Employee & Identity Management`, `Subsystem: InvoiceEdit.php`, `Subsystem: InvoiceList.php`, `Employee & Identity Management`, `Employee & Identity Management`, `Employee & Identity Management`, `Employee & Identity Management`, `Subsystem: ForgotPasswordBasic.php`, `Subsystem: RegisterBasic.php`, `Subsystem: ResetPasswordCover.php`, `Subsystem: TwoStepsCover.php`, `Subsystem: VerifyEmailCover.php`, `Flutter Mobile UI Components`, `Subsystem: Avatar.php`, `Subsystem: PerfectScrollbar.php`, `Subsystem: Tour.php`, `Subsystem: BasicInput.php`, `Subsystem: Picker.php`, `Subsystem: Sliders.php`, `Admin Panel Filament Resources`, `Subsystem: Blank.php`, `Subsystem: CollapsedMenu.php`, `Subsystem: Container.php`, `Employee & Identity Management`, `Subsystem: ContentNavbar.php`, `Subsystem: Vertical.php`, `Subsystem: WithoutMenu.php`, `Subsystem: Leaflet.php`, `Subsystem: AccountSettingsAccount.ph`, `Subsystem: AccountSettingsConnection`, `Subsystem: AccountSettingsSecurity.p`, `Subsystem: HelpCenterArticle.php`, `Subsystem: HelpCenterLanding.php`, `Subsystem: MiscUnderMaintenance.php`, `Employee & Identity Management`, `Admin Panel Filament Resources`, `Admin Panel Filament Resources`, `Admin Panel Filament Resources`, `Subsystem: Alerts.php`, `Subsystem: ListGroups.php`, `Subsystem: Modals.php`, `Subsystem: Spinners.php`, `Reporting & Form Engine`, `Reporting & Form Engine`, `Subsystem: Toasts.php`, `Subsystem: PropertyListing.php`, `Flutter Mobile UI Components`, `Odoo ERP & Principal Integration`, `API & Mobile State Providers`, `Visit & Itinerary Management`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `Principal` connect `Odoo ERP & Principal Integration` to `Odoo ERP & Principal Integration`, `Odoo ERP & Principal Integration`, `Attendance & Schedule Subsystem`, `Attendance & Schedule Subsystem`, `Attendance & Schedule Subsystem`, `Employee & Identity Management`, `Attendance & Schedule Subsystem`, `Admin Panel Filament Resources`, `Attendance & Schedule Subsystem`, `Attendance & Schedule Subsystem`, `Attendance & Schedule Subsystem`, `Employee & Identity Management`, `Reporting & Form Engine`, `Employee & Identity Management`, `Attendance & Schedule Subsystem`, `Attendance & Schedule Subsystem`, `Attendance & Schedule Subsystem`, `Reporting & Form Engine`, `Reporting & Form Engine`, `Odoo ERP & Principal Integration`, `Flutter Mobile UI Components`, `Attendance & Schedule Subsystem`, `Odoo ERP & Principal Integration`, `Odoo ERP & Principal Integration`?**
...
- **Should `Employee & Identity Management` be split into smaller, more focused modules?**
  _Cohesion score 0.005629763791411969 - nodes in this community are weakly interconnected._
- **Should `Subsystem: rich-editor.js` be split into smaller, more focused modules?**
  _Cohesion score 0.012023064654643601 - nodes in this community are weakly interconnected._
- **Should `Odoo ERP & Principal Integration` be split into smaller, more focused modules?**
  _Cohesion score 0.016257040450588837 - nodes in this community are weakly interconnected._