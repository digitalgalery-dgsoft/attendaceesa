...
## Corpus Check
- Large corpus: 1437 files · ~4,646,303 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 13945 nodes · 33413 edges · 839 communities (288 shown, 551 thin omitted)
...
- Attendance & Schedule Subsystem
- Attendance & Schedule Subsystem
- Subsystem: 2026_08_21_090000_set_jam
- Admin Panel Filament Resources
- Odoo ERP & Principal Integration
- Reporting & Form Engine
- Odoo ERP & Principal Integration
...
## Communities (839 total, 551 thin omitted)
...
Cohesion: 0.01
Nodes (19): {closure#7}(), {closure#2}(), {closure#1}(), {closure#150}(), {closure#151}(), {closure#153}(), {closure#156}(), {closure#161}() (+11 more)
...
### Community 6 - "Attendance & Schedule Subsystem"
Cohesion: 0.01
...
Cohesion: 0.02
Nodes (66): AreaForm, AreasTable, AttendanceBapForm, AttendanceBapsTable, AttendanceResource, Builder, UnitEnum, AttendanceForm (+58 more)

### Community 8 - "Attendance & Schedule Subsystem"
Cohesion: 0.02
Nodes (55): SendMissedCheckinNotification, EmployeeScheduleTemplateExport, {closure#1}(), {closure#5}(), {closure#11}(), {closure#11}(), {closure#12}(), {closure#14}() (+47 more)

### Community 9 - "Attendance & Schedule Subsystem"
Cohesion: 0.02
Nodes (38): {closure#6}(), {closure#9}(), {closure#1}(), EditWorkingGroup, ItineraryController, PayslipApiController, SalesPipelineController, BlastInfo (+30 more)
...
Cohesion: 0.02
Nodes (73): App\Filament\Resources\WorkingGroupResource\Pages, {closure#2}(), {closure#2}(), {closure#3}(), {closure#1}(), {closure#2}(), {closure#3}(), {closure#4}() (+65 more)

### Community 12 - "Attendance & Schedule Subsystem"
Cohesion: 0.02
Nodes (61): AreaResource, CreateArea, ListAreas, ListAttendanceBaps, CreateAttendance, ListAttendances, CreateBlastInfo, ListBlastInfos (+53 more)

### Community 13 - "Reporting & Form Engine"
Cohesion: 0.03
Nodes (64): Principal, ReportFormField, Carbon, ReportTemplate, {closure#1}(), down(), seedAllFonterraTemplates(), up() (+56 more)

### Community 14 - "Admin Panel Filament Resources"
Cohesion: 0.02
Nodes (47): AiSettings, BackedEnum, UnitEnum, {closure#1}(), {closure#2}(), ManageSettings, BackedEnum, UnitEnum (+39 more)
...
### Community 18 - "Subsystem: resolve()"
Cohesion: 0.05
Nodes (129): ad(), addKeyboardShortcuts(), after(), am(), as(), Ay(), bc(), before() (+121 more)

### Community 19 - "Attendance & Schedule Subsystem"
Cohesion: 0.03
Nodes (30): App\Filament\Resources\ExtraHourResource\Pages, App\Filament\Resources\PayslipResource\Pages, App\Filament\Resources\VisitReportResource\Pages, App\Filament\Resources\WorkTargetResource\Pages, {closure#7}(), {closure#1}(), {closure#12}(), {closure#14}() (+22 more)

### Community 20 - "Flutter Mobile UI Components"
Cohesion: 0.04
...
### Community 22 - "Attendance & Schedule Subsystem"
Cohesion: 0.03
Nodes (36): EditArea, EditAttendanceBap, EditAttendance, EditBlastInfo, EditBranch, CompanyResource, UnitEnum, CreateCompany (+28 more)

### Community 23 - "Reporting & Form Engine"
Cohesion: 0.03
...
Cohesion: 0.05
Nodes (12): AuthController, SalesReportController, ServerGatewayController, TenantAuthController, Carbon, PrincipalPortalController, Setting, AuthController (+4 more)

### Community 25 - "Subsystem: facet()"
Cohesion: 0.03
...
Cohesion: 0.03
Nodes (50): {closure#1}(), {closure#2}(), {closure#3}(), {closure#1}(), {closure#2}(), {closure#3}(), {closure#1}(), {closure#2}() (+42 more)

### Community 27 - "Subsystem: draw()"
Cohesion: 0.04
...
### Community 29 - "Subsystem: markdown-editor.js"
Cohesion: 0.05
Nodes (91): ad(), af(), An(), ao(), ar(), Ba(), bc(), bf() (+83 more)

### Community 30 - "Attendance & Schedule Subsystem"
Cohesion: 0.03
Nodes (51): {closure#10}(), {closure#11}(), {closure#12}(), {closure#13}(), {closure#14}(), {closure#15}(), {closure#16}(), {closure#17}() (+43 more)
...
### Community 34 - "Odoo ERP & Principal Integration"
Cohesion: 0.03
Nodes (23): CheckDuluxProductsCommand, CheckPrincipalsCommand, CleanDuluxWorkLocationsCommand, CreateDuluxDummyEmployeesCommand, DbLocksCommand, FixEmptyLocationCodesCommand, ImportAreasCommand, ImportDuluxAmkStoresCommand (+15 more)
...
Cohesion: 0.06
Nodes (32): AttendanceImportTemplateExport, AttendanceRosterMatrixExport, EmployeeScheduleMatrixTemplateExport, EmployeeScheduleRangeTemplateExport, MandaysExport, ManPowerExport, ShiftTemplateExport, TeamUncheckedExport (+24 more)

### Community 38 - "Odoo ERP & Principal Integration"
Cohesion: 0.04
Nodes (26): InstallController, Department, {closure#3}(), Position, User, up(), CompetitorProductSeeder, DashboardDemoSeeder (+18 more)
...
Cohesion: 0.03
Nodes (14): {closure#20}(), {closure#8}(), DashboardStatsWidget, AttendanceController, MeetingController, TrackingController, Attendance, AttendanceLog (+6 more)
...
Cohesion: 0.03
Nodes (17): {closure#1}(), BelongsToMany, Product, ReportSubmissionValue, up(), up(), {closure#2}(), up() (+9 more)

### Community 45 - "Subsystem: Ae()"
Cohesion: 0.07
Nodes (80): Ac(), Ae(), as(), bl(), cd(), ee(), ue(), ce() (+72 more)
...
### Community 53 - "Subsystem: flush()"
Cohesion: 0.05
Nodes (70): ag(), Ar(), br(), cg(), $d(), deleteSelection(), dg(), dl() (+62 more)

### Community 54 - "Subsystem: _update()"
Cohesion: 0.05
...
### Community 55 - "Visit & Itinerary Management"
Cohesion: 0.03
...
Cohesion: 0.04
Nodes (19): AttendanceBapResource, UnitEnum, CreateAttendanceBap, ViewAttendanceBap, ViewLeaveRequest, ListReportSubmissions, {closure#1}(), {closure#3}() (+11 more)

### Community 63 - "Subsystem: constructor()"
Cohesion: 0.05
Nodes (62): addExtensions(), addNode(), applyInitialSize(), Bn(), Cc(), configure(), constructor(), createCommandManager() (+54 more)

### Community 64 - "Odoo ERP & Principal Integration"
Cohesion: 0.04
...
### Community 67 - "Subsystem: y()"
Cohesion: 0.14
Nodes (58): Dg(), Ig(), Se(), al(), Be(), Cr(), Ct(), de() (+50 more)
...
Cohesion: 0.05
Nodes (10): ViewTrackingHistory, EmployeeScheduleRoster, Width, MeetingResource, UnitEnum, CreateMeeting, ListMeetings, ViewMeeting (+2 more)

### Community 81 - "Subsystem: ir()"
Cohesion: 0.09
Nodes (51): [g](), ar(), De(), Ft(), ir(), at(), be(), ce() (+43 more)
...
### Community 86 - "API & Mobile State Providers"
Cohesion: 0.06
Nodes (52): aa(), As(), Ba(), buildOrUpdateControllers(), buildOrUpdateElements(), cd(), _dataCheck(), _destroy() (+44 more)

### Community 87 - "API & Mobile State Providers"
Cohesion: 0.05
Nodes (10): {closure#11}(), {closure#12}(), {closure#5}(), {closure#7}(), DashboardApiController, PermitController, EmployeeLeaveQuota, LeaveRequest (+2 more)
...
### Community 95 - "Visit & Itinerary Management"
Cohesion: 0.04
Nodes (10): ItineraryResource, Builder, UnitEnum, CreateItinerary, ListItineraries, Width, {closure#10}(), {closure#15}() (+2 more)

### Community 96 - "Subsystem: eq()"
Cohesion: 0.06
Nodes (48): activeForPoint(), addActive(), Ar(), as(), boundChange(), chunkEnd(), commit(), compare() (+40 more)

### Community 97 - "Subsystem: T()"
Cohesion: 0.06
...
### Community 102 - "Employee & Identity Management"
Cohesion: 0.05
Nodes (15): EmployeeForm, LocationRequestForm, PayslipResource, Builder, UnitEnum, CreatePrincipal, Builder, UnitEnum (+7 more)

### Community 103 - "Subsystem: sliceDoc()"
Cohesion: 0.07
...
Cohesion: 0.06
Nodes (16): LocationRequestResource, Builder, UnitEnum, CreateLocationRequest, ViewLocationRequest, {closure#10}(), {closure#11}(), {closure#12}() (+8 more)

### Community 109 - "Subsystem: Si()"
Cohesion: 0.14
Nodes (41): At(), b(), bi(), bn(), ci(), cn(), ct(), di() (+33 more)

### Community 110 - "Subsystem: getDatasetMeta()"
Cohesion: 0.06
Nodes (41): afterDatasetsUpdate(), An(), ar(), beforeDatasetDraw(), beforeDatasetsDraw(), beforeDraw(), _d(), datasetElementScopeKeys() (+33 more)

### Community 111 - "Flutter Mobile UI Components"
Cohesion: 0.12
...
### Community 117 - "Subsystem: lineAt()"
Cohesion: 0.08
...
### Community 119 - "Subsystem: slider.js"
Cohesion: 0.11
...
### Community 121 - "Flutter Mobile UI Components"
Cohesion: 0.06
...
### Community 123 - "API & Mobile State Providers"
Cohesion: 0.06
...
### Community 124 - "Subsystem: att-admin-v12/routes/web."
Cohesion: 0.06
Nodes (8): Area, {closure#3}(), {closure#4}(), GET /(), GET /admin/impersonate-start/{user}(), GET /admin/impersonate/{user}(), Request, User

### Community 125 - "Subsystem: n()"
Cohesion: 0.11
Nodes (36): _a(), r(), dd(), df(), Dn(), Eo(), er(), a() (+28 more)

### Community 126 - "Admin Panel Filament Resources"
Cohesion: 0.07
...
### Community 135 - "Employee & Identity Management"
Cohesion: 0.07
Nodes (10): App\Http\Controllers\Api\EmployeeController, BlastInfoController, NotificationController, GET /user(), {closure#2}(), RouteServiceProvider, Illuminate\Cache\RateLimiting\Limit, Illuminate\Foundation\Support\Providers\RouteServiceProvider (+2 more)

### Community 136 - "Flutter Mobile UI Components"
Cohesion: 0.06
...
### Community 141 - "Reporting & Form Engine"
Cohesion: 0.08
...
### Community 148 - "Subsystem: components/select.js"
Cohesion: 0.11
Nodes (17): be(), Bt(), ei(), en(), gt(), jn(), Ln(), ni() (+9 more)

### Community 149 - "Subsystem: i()"
Cohesion: 0.12
Nodes (23): al(), compute(), i(), createParse(), cX(), f(), h(), m() (+15 more)

### Community 150 - "Reporting & Form Engine"
Cohesion: 0.10
Nodes (7): OdooSyncReport, BackedEnum, UnitEnum, Width, {closure#1}(), OdooSyncStreamController, OdooSyncLog

### Community 151 - "Subsystem: va()"
Cohesion: 0.14
Nodes (24): Aa(), at(), cf(), da(), fa(), ga(), Gr(), Jc() (+16 more)

### Community 152 - "Subsystem: fn()"
Cohesion: 0.13
...
Cohesion: 0.14
Nodes (9): {closure#10}(), {closure#11}(), {closure#13}(), {closure#14}(), {closure#16}(), {closure#5}(), {closure#8}(), ExtraHourController (+1 more)

### Community 168 - "Subsystem: destroy()"
Cohesion: 0.15
Nodes (17): atLastNode(), destroy(), getDOMAfter(), ignore(), move(), NP(), prev(), scroll() (+9 more)

### Community 169 - "Subsystem: Ew()"
Cohesion: 0.20
Nodes (16): ai(), ki(), Nc(), Pc(), rf(), Ri(), si(), Vr() (+8 more)

### Community 170 - "Subsystem: fn()"
Cohesion: 0.24
Nodes (17): Ae(), Ce(), De(), fn(), Ft(), ht(), ii(), Le() (+9 more)
...
### Community 178 - "Subsystem: TestCase"
Cohesion: 0.16
...
### Community 181 - "API & Mobile State Providers"
Cohesion: 0.13
...
### Community 182 - "Subsystem: color-picker.js"
Cohesion: 0.14
...
### Community 184 - "Subsystem: .prettierrc.json"
Cohesion: 0.13
...
### Community 210 - "Reporting & Form Engine"
Cohesion: 0.20
...
### Community 211 - "Admin Panel Filament Resources"
Cohesion: 0.20
...
### Community 212 - "Subsystem: Doc: implementation-playb"
Cohesion: 0.20
...
### Community 215 - "Subsystem: Doc: PANDUAN_MIGRASI_SWIT"
Cohesion: 0.20
...
### Community 216 - "Odoo ERP & Principal Integration"
Cohesion: 0.20
...
### Community 219 - "Reporting & Form Engine"
Cohesion: 0.25
Nodes (3): {closure#1}(), {closure#2}(), TemplateSyncService

### Community 220 - "Subsystem: att-admin-v12/bootstrap/a"
Cohesion: 0.28
...
### Community 221 - "Subsystem: scripts"
Cohesion: 0.22
Nodes (9): scripts, dev, post-autoload-dump, post-create-project-cmd, post-root-package-install, post-update-cmd, pre-package-uninstall, setup (+1 more)

### Community 222 - "Subsystem: X()"
Cohesion: 0.28
Nodes (9): A(), An(), e(), ue(), vi(), c(), X(), xn() (+1 more)

### Community 224 - "Employee & Identity Management"
Cohesion: 0.22
...
### Community 227 - "Subsystem: require-dev"
Cohesion: 0.25
...
### Community 229 - "Subsystem: domAtPos()"
Cohesion: 0.25
...
### Community 240 - "Attendance & Schedule Subsystem"
Cohesion: 0.29
...
### Community 243 - "Reporting & Form Engine"
Cohesion: 0.29
Nodes (4): {closure#1}(), {closure#2}(), {closure#3}(), {closure#4}()

### Community 244 - "Reporting & Form Engine"
Cohesion: 0.29
Nodes (4): {closure#1}(), {closure#2}(), {closure#3}(), {closure#4}()
...
### Community 246 - "Subsystem: PHPUnit\Framework\TestCas"
Cohesion: 0.38
Nodes (3): ExampleTest, ExampleTest, PHPUnit\Framework\TestCase

### Community 247 - "Subsystem: app-kanban.js"
Cohesion: 0.38
Nodes (4): renderAvatar(), renderDropdown(), renderFooter(), renderHeader()

### Community 248 - "Subsystem: payslip.dart"
Cohesion: 0.29
...
### Community 250 - "Admin Panel Filament Resources"
Cohesion: 0.29
...
### Community 251 - "Subsystem: Doc: implementation-playb"
Cohesion: 0.29
...
### Community 252 - "Subsystem: Doc: SKILL.md"
Cohesion: 0.29
...
### Community 254 - "Attendance & Schedule Subsystem"
Cohesion: 0.29
...
### Community 255 - "Odoo ERP & Principal Integration"
Cohesion: 0.29
...
### Community 257 - "Subsystem: att-admin-v12/config/logg"
Cohesion: 0.47
...
### Community 259 - "Subsystem: 2026_08_13_100000_add_cut"
Cohesion: 0.33
Nodes (3): {closure#1}(), {closure#2}(), {closure#3}()

### Community 260 - "Admin Panel Filament Resources"
Cohesion: 0.33
Nodes (3): {closure#1}(), {closure#2}(), {closure#3}()
...
### Community 272 - "Admin Panel Filament Resources"
Cohesion: 0.33
...
### Community 336 - "Subsystem: horizontalLayout.blade.ph"
Cohesion: 0.40
...
### Community 338 - "Subsystem: deploy.sh"
Cohesion: 0.70
Nodes (4): deploy_local_dev(), deploy_three_prod_servers(), setup_ssh_pairing(), deploy.sh script

### Community 339 - "Attendance & Schedule Subsystem"
Cohesion: 0.40
...
### Community 394 - "Reporting & Form Engine"
Cohesion: 0.50
...
### Community 397 - "Subsystem: extra"
Cohesion: 0.67
Nodes (3): extra, laravel, dont-discover

### Community 398 - "Subsystem: pt()"
Cohesion: 0.67
Nodes (3): H(), ji(), pt()

### Community 415 - "Subsystem: Doc: implementation-playb"
Cohesion: 0.67
Nodes (3): Doc: implementation-playbook.md, Dependency Audit and Security Analysis Implementat, Instructions

### Community 416 - "Subsystem: Doc: README.md"
Cohesion: 0.67
Nodes (3): Doc: README.md, Getting Started, att_mobile

### Community 417 - "Attendance & Schedule Subsystem"
Cohesion: 0.67
...
- **2141 isolated node(s):** `SortDirection`, `$schema`, `name`, `type`, `description` (+2136 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 5414 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **551 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `BlastInfo` connect `Attendance & Schedule Subsystem` to `Flutter Mobile UI Components`, `Attendance & Schedule Subsystem`, `Employee & Identity Management`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `ReportTemplate` connect `Reporting & Form Engine` to `Odoo ERP & Principal Integration`, `Attendance & Schedule Subsystem`, `Attendance & Schedule Subsystem`, `Attendance & Schedule Subsystem`, `Reporting & Form Engine`, `Attendance & Schedule Subsystem`, `Attendance & Schedule Subsystem`, `Reporting & Form Engine`, `Reporting & Form Engine`, `Reporting & Form Engine`, `Odoo ERP & Principal Integration`, `Attendance & Schedule Subsystem`, `Odoo ERP & Principal Integration`, `Reporting & Form Engine`, `Reporting & Form Engine`, `API & Mobile State Providers`, `Reporting & Form Engine`, `Visit & Itinerary Management`, `API & Mobile State Providers`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `Controller` connect `Employee & Identity Management` to `Employee & Identity Management`, `Odoo ERP & Principal Integration`, `Odoo ERP & Principal Integration`, `Odoo ERP & Principal Integration`, `Employee & Identity Management`, `Employee & Identity Management`, `Attendance & Schedule Subsystem`, `Attendance & Schedule Subsystem`, `Employee & Identity Management`, `Attendance & Schedule Subsystem`, `Odoo ERP & Principal Integration`, `Employee & Identity Management`, `API & Mobile State Providers`, `Reporting & Form Engine`, `Reporting & Form Engine`, `Reporting & Form Engine`?**
...
- **Should `Odoo ERP & Principal Integration` be split into smaller, more focused modules?**
  _Cohesion score 0.008221343873517787 - nodes in this community are weakly interconnected._