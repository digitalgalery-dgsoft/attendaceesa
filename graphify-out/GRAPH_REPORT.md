...
## Corpus Check
- Large corpus: 1438 files · ~4,652,217 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 13956 nodes · 33441 edges · 878 communities (287 shown, 591 thin omitted)
...
- Flutter Mobile UI Components
- Visit & Itinerary Management
- Subsystem: att-admin-v12/routes/web.
...
- Odoo ERP & Principal Integration
- Subsystem: 2026_08_13_100000_add_cut
- Admin Panel Filament Resources
- Odoo ERP & Principal Integration
- Subsystem: 2026_08_31_080000_add_is_
- Admin Panel Filament Resources
...
- Employee & Identity Management
- Admin Panel Filament Resources
- Subsystem: 2026_07_03_000008_add_con
...
- Admin Panel Filament Resources
- Admin Panel Filament Resources
- Subsystem: 2026_09_01_200000_set_def
- Reporting & Form Engine
- Attendance & Schedule Subsystem
- Admin Panel Filament Resources
- Admin Panel Filament Resources
...
- Employee & Identity Management
- Subsystem: Chat.php
- Subsystem: InvoiceEdit.php
- Subsystem: InvoiceList.php
- Flutter Mobile UI Components
- Employee & Identity Management
- Employee & Identity Management
- Subsystem: ForgotPasswordBasic.php
- Employee & Identity Management
- Subsystem: RegisterBasic.php
- Subsystem: RegisterMultiSteps.php
- Subsystem: ResetPasswordBasic.php
- Subsystem: ResetPasswordCover.php
- Subsystem: TwoStepsCover.php
- Flutter Mobile UI Components
- Subsystem: Avatar.php
- Subsystem: BlockUI.php
- Subsystem: PerfectScrollbar.php
- Subsystem: Tour.php
- Subsystem: BasicInput.php
- Subsystem: Picker.php
- Subsystem: Sliders.php
- Subsystem: Switches.php
- Admin Panel Filament Resources
- Subsystem: StickyActions.php
- Admin Panel Filament Resources
- Subsystem: Blank.php
- Subsystem: CollapsedMenu.php
- Subsystem: ContentNavbar.php
- Subsystem: Vertical.php
- Subsystem: WithoutMenu.php
- Subsystem: AccountSettingsAccount.ph
- Subsystem: AccountSettingsBilling.ph
- Subsystem: AccountSettingsConnection
- Subsystem: HelpCenterArticle.php
- Employee & Identity Management
- Admin Panel Filament Resources
- Subsystem: Collapse.php
- Subsystem: ListGroups.php
- Subsystem: Navbar.php
...
- `AccessRoles` --inherits--> `Controller`  [EXTRACTED]
  att-admindashboard/app/Http/Controllers/apps/AccessRoles.php → att-admin-v12/app/Http/Controllers/Controller.php

## Import Cycles
- None detected.

## Communities (878 total, 591 thin omitted)

### Community 0 - "Employee & Identity Management"
Cohesion: 0.01
Nodes (133): Ac(), addActive(), addCompletion(), addCompletions(), addEventListener(), addNamespace(), addNamespaceObject(), addWindowListeners() (+125 more)

### Community 1 - "Odoo ERP & Principal Integration"
Cohesion: 0.01
Nodes (95): CheckDuluxProductsCommand, CheckPrincipalsCommand, CleanDuluxWorkLocationsCommand, DbLocksCommand, ImportAreasCommand, ImportDuluxCbpCommand, ImportDuluxDailyMaintenanceCommand, ImportDuluxOfftakeCommand (+87 more)

### Community 2 - "Subsystem: rich-editor.js"
Cohesion: 0.01
Nodes (183): $0(), Ab(), ac(), addAttributes(), addExtensions(), addHackNode(), addNode(), addOptions() (+175 more)

### Community 3 - "API & Mobile State Providers"
Cohesion: 0.01
Nodes (84): Controller, AccessPermission, Calendar, Email, InvoiceAdd, InvoicePrint, Kanban, UserList (+76 more)

### Community 5 - "Attendance & Schedule Subsystem"
Cohesion: 0.01
Nodes (247): AttendanceProvider, DynamicReportingProvider, build, initState, _submitAttendance, didChangeAppLifecycleState, _enrollMasterFace, _activeDiscountType (+239 more)
...
Cohesion: 0.01
Nodes (62): ImportDuluxAmkStoresCommand, ImportInhouseStoresCommand, EmployeeScheduleTemplateExport, {closure#1}(), {closure#2}(), Width, {closure#1}(), {closure#2}() (+54 more)

### Community 8 - "Attendance & Schedule Subsystem"
Cohesion: 0.02
Nodes (52): CreateDuluxDummyEmployeesCommand, FixOrphanedEmployeeDataCommand, {closure#1}(), {closure#2}(), {closure#3}(), {closure#4}(), {closure#5}(), {closure#6}() (+44 more)

### Community 9 - "Attendance & Schedule Subsystem"
Cohesion: 0.02
Nodes (39): {closure#6}(), {closure#9}(), MeetingController, SalesPipelineController, BlastInfo, CompetitorProduct, Holiday, ItineraryItem (+31 more)

### Community 10 - "Employee & Identity Management"
Cohesion: 0.02
Nodes (170): AuthProvider, DashboardProvider, LocaleProvider, NotificationProvider, OvertimeProvider, PayslipProvider, ThemeProvider, build (+162 more)

### Community 11 - "Employee & Identity Management"
Cohesion: 0.02
Nodes (165): _appColor, _appName, _employeeData, fetchSettings, _getDeviceInfo, isAuthenticated, _isLoading, login (+157 more)

### Community 12 - "Attendance & Schedule Subsystem"
Cohesion: 0.02
Nodes (57): AreaForm, AreasTable, AttendanceBapResource, UnitEnum, AttendanceBapForm, AttendanceBapsTable, AttendanceResource, Builder (+49 more)

### Community 13 - "Attendance & Schedule Subsystem"
Cohesion: 0.02
Nodes (39): {closure#1}(), {closure#2}(), {closure#20}(), {closure#3}(), {closure#5}(), {closure#7}(), {closure#8}(), {closure#11}() (+31 more)
...
### Community 15 - "Attendance & Schedule Subsystem"
Cohesion: 0.03
Nodes (42): App\Filament\Resources\PayslipResource\Pages, App\Filament\Resources\VisitReportResource\Pages, App\Filament\Resources\WorkingGroupResource\Pages, App\Filament\Resources\WorkTargetResource\Pages, {closure#1}(), {closure#2}(), {closure#3}(), {closure#1}() (+34 more)
...
### Community 17 - "Flutter Mobile UI Components"
Cohesion: 0.04
Nodes (121): _a(), addGlobalAttributes(), addNodeView(), addProseMirrorPlugins(), af(), c(), d(), atEnd() (+113 more)

### Community 18 - "Subsystem: constructor()"
Cohesion: 0.03
Nodes (123): add(), addChunk(), addInfoPane(), addInner(), adjust(), annotation(), applyChanges(), applyEdits() (+115 more)

### Community 19 - "Subsystem: facet()"
Cohesion: 0.03
Nodes (114): accept(), active(), Ah(), apply(), applyTransaction(), asSingle(), b0(), baseTheme() (+106 more)

### Community 20 - "Subsystem: draw()"
Cohesion: 0.04
Nodes (110): acquireContext(), adjustHitBoxes(), Ao(), aspectRatio(), B(), bh(), calculateLabelRotation(), _calculatePadding() (+102 more)

### Community 21 - "Employee & Identity Management"
Cohesion: 0.04
Nodes (109): aa(), acceptToken(), allows(), au(), b1(), Bg(), ch(), child() (+101 more)

### Community 22 - "Subsystem: push()"
Cohesion: 0.03
Nodes (106): Ai(), ao(), Ar(), as(), Ba(), bi(), bn(), checkForConsuming() (+98 more)

### Community 23 - "Subsystem: resolve()"
Cohesion: 0.06
Nodes (106): ad(), addKeyboardShortcuts(), after(), An(), apply(), as(), Ay(), before() (+98 more)

### Community 24 - "Attendance & Schedule Subsystem"
Cohesion: 0.02
Nodes (99): Animation, AnimationController, AttendanceLocationScreen, _AttendanceLocationScreenState, build, createState, _currentPage, dispose (+91 more)

### Community 25 - "Employee & Identity Management"
Cohesion: 0.03
Nodes (51): {closure#1}(), {closure#2}(), {closure#3}(), {closure#1}(), {closure#2}(), {closure#3}(), {closure#1}(), {closure#2}() (+43 more)

### Community 26 - "Employee & Identity Management"
Cohesion: 0.02
Nodes (100): AuthWrapper, _AuthWrapperState, build, createState, didChangeAppLifecycleState, dispose, _hasSeenOnboarding, _initFuture (+92 more)

### Community 27 - "Subsystem: _update()"
Cohesion: 0.04
...
### Community 28 - "Attendance & Schedule Subsystem"
Cohesion: 0.02
Nodes (97): BapScreen, _BapScreenState, build, _buildFormTab, _buildHistoryTab, _buildSectionHeader, _buildTabButton, _categories (+89 more)

### Community 29 - "Admin Panel Filament Resources"
Cohesion: 0.04
Nodes (99): ac(), ae(), after(), ag(), Al(), Am(), before(), bl() (+91 more)

### Community 30 - "Subsystem: markdown-editor.js"
Cohesion: 0.05
Nodes (90): Aa(), ad(), Ae(), af(), ai(), An(), ao(), Ba() (+82 more)

### Community 31 - "Attendance & Schedule Subsystem"
Cohesion: 0.03
Nodes (42): {closure#10}(), {closure#2}(), {closure#3}(), {closure#4}(), {closure#5}(), {closure#6}(), {closure#7}(), EmployeeResource (+34 more)

### Community 32 - "Odoo ERP & Principal Integration"
Cohesion: 0.06
Nodes (11): ExtraHourController, TenantAuthController, OdooSyncStreamController, Carbon, PrincipalPortalController, Setting, GET /(), Request (+3 more)
...
### Community 35 - "Admin Panel Filament Resources"
Cohesion: 0.05
Nodes (90): addMaps(), addNodeMark(), addStep(), addTransform(), allowedMarks(), append(), appendMap(), appendMapping() (+82 more)
...
Cohesion: 0.06
Nodes (90): add(), addCommands(), addInputRules(), addMark(), ak(), allowsMarks(), Ap(), bk() (+82 more)

### Community 38 - "Attendance & Schedule Subsystem"
Cohesion: 0.04
Nodes (30): EditArea, EditAttendanceBap, EditAttendance, EditBlastInfo, EditCompany, EditCompetitorProduct, EditDepartment, EditEmployee (+22 more)

### Community 39 - "Attendance & Schedule Subsystem"
Cohesion: 0.03
Nodes (30): ListAreas, ListAttendanceBaps, ListAttendances, ListBlastInfos, ListBranches, ListCompanies, ListCompetitorProducts, ListDepartments (+22 more)

### Community 40 - "Attendance & Schedule Subsystem"
Cohesion: 0.02
Nodes (83): MeetingDetailModel, MeetingModel, _activeMeeting, _activePermit, _canCheckin, _canVisit, checkAttendanceStatus, _checkinBlockMessage (+75 more)

### Community 41 - "Attendance & Schedule Subsystem"
Cohesion: 0.06
Nodes (33): AttendanceImportTemplateExport, AttendanceRosterMatrixExport, EmployeeScheduleMatrixTemplateExport, EmployeeScheduleRangeTemplateExport, MandaysExport, ManPowerExport, ShiftTemplateExport, TeamUncheckedExport (+25 more)

### Community 42 - "Visit & Itinerary Management"
Cohesion: 0.03
Nodes (20): Login, Dashboard, ItineraryResource, Builder, UnitEnum, CreateItinerary, {closure#10}(), {closure#9}() (+12 more)

### Community 43 - "Attendance & Schedule Subsystem"
Cohesion: 0.03
Nodes (79): address, createState, _currentPosition, dispose, _getCurrentLocation, _getScheduledLocations, id, initialWorkLocationId (+71 more)

### Community 44 - "Reporting & Form Engine"
Cohesion: 0.04
Nodes (17): OdooSyncReport, BackedEnum, UnitEnum, Width, ActiveEmployeesHourlyChartWidget, AttendanceChartWidget, MandaysChartWidget, ManPowerChartWidget (+9 more)

### Community 45 - "Attendance & Schedule Subsystem"
Cohesion: 0.03
Nodes (32): AreaResource, CreateArea, CreateAttendanceBap, CreateAttendance, CreateBlastInfo, CompanyResource, UnitEnum, CreateCompany (+24 more)

### Community 46 - "Subsystem: __fire()"
Cohesion: 0.05
...
### Community 47 - "Subsystem: lineAt()"
Cohesion: 0.04
Nodes (76): activateHover(), balanced(), baseDirAt(), baseIndent(), baseIndentFor(), bidiIn(), bidiSpans(), bidiSpansAt() (+68 more)

### Community 48 - "Subsystem: n()"
Cohesion: 0.08
Nodes (77): _a(), ar(), at(), bc(), ue(), u(), ci(), r() (+69 more)

### Community 49 - "Reporting & Form Engine"
Cohesion: 0.03
...
### Community 51 - "Flutter Mobile UI Components"
Cohesion: 0.03
Nodes (71): PermitProvider, SalesProvider, build, createState, _cutiTypes, _endDate, _formKey, _imageFile (+63 more)

### Community 52 - "Subsystem: advance()"
Cohesion: 0.04
Nodes (73): addChild(), addElement(), addGaps(), addLeafElement(), addNode(), advance(), ATXHeading(), balance() (+65 more)

### Community 53 - "Subsystem: .slice()"
Cohesion: 0.05
Nodes (71): accepts(), addInner(), Ah(), at(), Ba(), Bi(), bl(), bu() (+63 more)

### Community 54 - "Subsystem: t()"
Cohesion: 0.05
Nodes (70): al(), AQ(), AX(), be(), a(), blockTiles(), combine(), compose() (+62 more)

### Community 55 - "Subsystem: dependencies"
Cohesion: 0.03
Nodes (72): dependencies, animate.css, aos, apexcharts-clevision, autosize, block-ui, bloodhound-js, bootstrap (+64 more)

### Community 56 - "Subsystem: file-upload.js"
Cohesion: 0.05
Nodes (50): am(), Ap(), be(), bi(), Bp(), c(), clickPercent(), cm() (+42 more)

### Community 57 - "Subsystem: support.js"
Cohesion: 0.05
Nodes (51): apply(), as(), At(), bo(), bs(), close(), closeQuietly(), co() (+43 more)

### Community 58 - "Subsystem: flush()"
Cohesion: 0.05
Nodes (67): gX(), ag(), Ar(), Bd(), cg(), $d(), dg(), disconnectSelection() (+59 more)

### Community 59 - "Admin Panel Filament Resources"
Cohesion: 0.04
Nodes (32): {closure#2}(), {closure#1}(), {closure#3}(), {closure#4}(), {closure#5}(), Component, {closure#12}(), {closure#17}() (+24 more)
...
### Community 62 - "Subsystem: _update()"
Cohesion: 0.06
...
### Community 63 - "Reporting & Form Engine"
Cohesion: 0.03
...
### Community 67 - "Visit & Itinerary Management"
Cohesion: 0.03
Nodes (11): {closure#1}(), {closure#1}(), {closure#1}(), {closure#1}(), {closure#2}(), {closure#1}(), {closure#1}(), {closure#1}() (+3 more)

### Community 68 - "Attendance & Schedule Subsystem"
Cohesion: 0.03
Nodes (10): {closure#1}(), {closure#1}(), {closure#1}(), {closure#1}(), {closure#1}(), {closure#1}(), {closure#1}(), {closure#1}() (+2 more)

### Community 69 - "Subsystem: y()"
Cohesion: 0.10
Nodes (58): Se(), al(), as(), Be(), Cr(), da(), de(), df() (+50 more)

### Community 70 - "Attendance & Schedule Subsystem"
Cohesion: 0.04
Nodes (17): ViewAttendanceBap, ViewLeaveRequest, ViewLocationRequest, ListReportSubmissions, {closure#1}(), {closure#3}(), ViewReportSubmission, Builder (+9 more)
...
### Community 73 - "Flutter Mobile UI Components"
Cohesion: 0.04
...
Cohesion: 0.17
Nodes (50): b(), $c(), X(), D(), _e(), se(), G(), ge() (+42 more)

### Community 77 - "Attendance & Schedule Subsystem"
Cohesion: 0.04
Nodes (20): EmployeeForm, ListEmployeeSchedules, LocationRequestForm, PayslipResource, Builder, UnitEnum, CreatePrincipal, Builder (+12 more)

### Community 78 - "Subsystem: ir()"
Cohesion: 0.09
...
### Community 80 - "Subsystem: columns/select.js"
Cohesion: 0.08
Nodes (43): Ae(), Ai(), An(), applyDisabledState(), be(), Bt(), De(), disable() (+35 more)

### Community 81 - "Odoo ERP & Principal Integration"
Cohesion: 0.07
Nodes (11): OdooSyncCommand, {closure#3}(), {closure#4}(), {closure#5}(), OdooSync, BackedEnum, UnitEnum, OdooSyncService (+3 more)
...
### Community 83 - "Subsystem: ar()"
Cohesion: 0.05
Nodes (52): addEventListener(), ar(), au(), beforeDatasetDraw(), beforeDatasetsDraw(), beforeDraw(), beforeLayout(), bi() (+44 more)

### Community 84 - "Reporting & Form Engine"
Cohesion: 0.04
Nodes (3): {closure#11}(), {closure#26}(), {closure#34}()

### Community 85 - "Subsystem: eq()"
Cohesion: 0.06
Nodes (51): a$(), activeForPoint(), addBlock(), addLineDeco(), B(), blankContent(), boundChange(), commit() (+43 more)

### Community 86 - "Admin Panel Filament Resources"
Cohesion: 0.05
Nodes (8): Ud(), Bi(), Bn(), ji(), qd(), te(), we(), Xc()

### Community 87 - "Odoo ERP & Principal Integration"
Cohesion: 0.07
...
### Community 88 - "API & Mobile State Providers"
Cohesion: 0.08
Nodes (8): BapApiController, LocationRequestApiController, ReportingApiController, TemplateSyncController, {closure#1}(), ReportSubmission, GoogleMapsService, Illuminate\Http\JsonResponse

### Community 89 - "Subsystem: slice()"
Cohesion: 0.06
Nodes (50): addChanges(), addSelection(), as(), composeDesc(), d0(), De(), decompose(), Du() (+42 more)
...
### Community 93 - "Subsystem: Ew()"
Cohesion: 0.08
Nodes (47): Pi(), Ti(), Ac(), bl(), Cc(), ee(), ce(), cl() (+39 more)

### Community 94 - "Admin Panel Filament Resources"
Cohesion: 0.13
Nodes (46): A(), ae(), B(), be(), C(), ce(), E(), ee() (+38 more)

### Community 95 - "Employee & Identity Management"
Cohesion: 0.04
Nodes (46): build, message, onRetry, SecurityWarningScreen, title, _auth, authenticate, BiometricService (+38 more)

### Community 96 - "Subsystem: addElementByRule()"
Cohesion: 0.07
Nodes (48): addAll(), addDOM(), addElement(), addElementByRule(), addTextNode(), addToSet(), allowsMarkType(), am() (+40 more)

### Community 97 - "Employee & Identity Management"
Cohesion: 0.06
Nodes (48): Eo(), ac(), addEventListener(), al(), bindEvents(), bindResponsiveEvents(), bindUserEvents(), bs() (+40 more)

### Community 98 - "Subsystem: reduce()"
Cohesion: 0.08
...
### Community 101 - "Subsystem: nodesBetween()"
Cohesion: 0.07
Nodes (45): addStoredMark(), Bo(), childAfter(), childBefore(), Cn(), Cu(), dc(), dr() (+37 more)
...
### Community 104 - "Admin Panel Filament Resources"
Cohesion: 0.06
...
### Community 105 - "Subsystem: Si()"
Cohesion: 0.13
Nodes (43): setOrder(), At(), bi(), bn(), ci(), cn(), ct(), di() (+35 more)
...
### Community 107 - "Subsystem: Xt()"
Cohesion: 0.13
Nodes (42): At(), b(), bi(), bn(), Ce(), ci(), cn(), ct() (+34 more)

### Community 108 - "Admin Panel Filament Resources"
Cohesion: 0.08
Nodes (42): buildOrUpdateScales(), D(), determineDataLimits(), dh(), diff(), En(), endOf(), ensureScalesHaveIDs() (+34 more)

### Community 109 - "API & Mobile State Providers"
Cohesion: 0.21
Nodes (4): WingsMbrExportService, PhpOffice\PhpSpreadsheet\Spreadsheet, PhpOffice\PhpSpreadsheet\Worksheet\Worksheet, Symfony\Component\HttpFoundation\StreamedResponse

### Community 110 - "Flutter Mobile UI Components"
Cohesion: 0.06
Nodes (16): LocationRequestResource, Builder, UnitEnum, CreateLocationRequest, {closure#10}(), {closure#11}(), {closure#12}(), {closure#13}() (+8 more)

### Community 111 - "Attendance & Schedule Subsystem"
Cohesion: 0.07
Nodes (15): SendMissedCheckinNotification, {closure#10}(), {closure#11}(), {closure#12}(), {closure#13}(), {closure#14}(), {closure#15}(), {closure#16}() (+7 more)
...
### Community 113 - "Visit & Itinerary Management"
Cohesion: 0.06
Nodes (38): ItineraryProvider, AddItineraryScreen, _AddItineraryScreenState, _agendaController, _buildSearchableSelectField, createState, _fetchData, initialDate (+30 more)

### Community 114 - "Subsystem: att-admin-v12/routes/web."
Cohesion: 0.05
Nodes (7): Area, {closure#3}(), {closure#4}(), GET /admin/impersonate-start/{user}(), GET /admin/impersonate/{user}(), User, Illuminate\Support\Facades\Route

### Community 115 - "Subsystem: sliceString()"
Cohesion: 0.07
Nodes (38): addToSet(), bd(), Bh(), childString(), clearDelayedAndroidKey(), r(), dd(), delayAndroidKey() (+30 more)

### Community 116 - "Subsystem: slider.js"
Cohesion: 0.11
Nodes (36): tn(), We(), Ae(), Be(), Bt(), Ce(), _e(), Ee() (+28 more)

### Community 117 - "Subsystem: d()"
Cohesion: 0.14
Nodes (36): Ai(), ar(), c(), d(), destroy(), Do(), f(), Fa() (+28 more)

### Community 118 - "Subsystem: Cn()"
Cohesion: 0.16
Nodes (36): Cn(), b(), Ce(), De(), dn(), _e(), F(), Fe() (+28 more)

### Community 119 - "Subsystem: add()"
Cohesion: 0.07
Nodes (39): active(), add(), _animateOptions(), beforeUpdate(), _cachedScopes(), cancel(), ci(), _createAnimations() (+31 more)

### Community 120 - "Employee & Identity Management"
Cohesion: 0.05
Nodes (38): build, _buildCaseOption, _buildLiveChatView, _buildNikFormView, _buildProfileRow, _buildTicketCard, _chatInputController, _checkNik (+30 more)

### Community 121 - "Visit & Itinerary Management"
Cohesion: 0.07
Nodes (9): App\Models\Permit, ItineraryController, ServerGatewayController, SettingSyncController, SettingSyncService, Google\Client, Illuminate\Support\Facades\Cache, Illuminate\Support\Facades\Http (+1 more)

### Community 122 - "Admin Panel Filament Resources"
Cohesion: 0.06
Nodes (16): AiSettings, BackedEnum, UnitEnum, {closure#1}(), {closure#2}(), ManageSettings, BackedEnum, UnitEnum (+8 more)
...
### Community 124 - "Visit & Itinerary Management"
Cohesion: 0.06
...
### Community 125 - "Subsystem: echo.js"
Cohesion: 0.08
Nodes (19): ar(), Be(), cr(), d(), ei(), f(), ii(), le() (+11 more)

### Community 126 - "Subsystem: components/select.js"
Cohesion: 0.10
Nodes (25): A(), An(), b(), be(), Bt(), e(), ei(), en() (+17 more)

### Community 127 - "Reporting & Form Engine"
Cohesion: 0.09
...
Cohesion: 0.06
Nodes (6): App\Http\Controllers\Api\EmployeeController, AuthController, BlastInfoController, NotificationController, SalesReportController, GET /user()

### Community 129 - "Attendance & Schedule Subsystem"
Cohesion: 0.07
Nodes (6): AttendanceRoster, Width, ViewTrackingHistory, ViewMeeting, Filament\Resources\Pages\Concerns\InteractsWithRecord, Filament\Resources\Pages\Page

### Community 130 - "Subsystem: Ue()"
Cohesion: 0.11
Nodes (34): Ax(), bx(), c(), ct(), dx(), ex(), Fh(), Gh() (+26 more)

### Community 131 - "Subsystem: getDatasetMeta()"
Cohesion: 0.09
Nodes (33): afterDatasetsUpdate(), fc(), gc(), generateLabels(), getDatasetMeta(), getDataVisibility(), getMaxBorderWidth(), getStyle() (+25 more)

### Community 132 - "Flutter Mobile UI Components"
Cohesion: 0.08
...
### Community 133 - "Employee & Identity Management"
Cohesion: 0.07
...
### Community 138 - "Attendance & Schedule Subsystem"
Cohesion: 0.07
Nodes (28): AttendanceApp, ComingSoonScreen, build, LeaveScreen, PrivacyPolicyScreen, DashboardStatsWidget, _animation, borderRadius (+20 more)

### Community 139 - "Visit & Itinerary Management"
Cohesion: 0.07
Nodes (29): _actionController, _activePromoController, _actualQtyController, _actualValueController, _buildSectionHeader, createState, _deadline, dispose (+21 more)

### Community 140 - "Subsystem: _updateHiddenPolyCircle()"
Cohesion: 0.11
...
### Community 141 - "Subsystem: Pe()"
Cohesion: 0.13
Nodes (29): ca(), cd(), me(), dt(), gl(), _i(), Ie(), it() (+21 more)
...
### Community 144 - "Subsystem: TeamUncheckedMonitoring"
Cohesion: 0.09
Nodes (5): {closure#1}(), BackedEnum, UnitEnum, Width, TeamUncheckedMonitoring

### Community 145 - "Admin Panel Filament Resources"
Cohesion: 0.12
Nodes (22): B(), close(), E(), F(), G(), I(), L(), N() (+14 more)

### Community 146 - "Subsystem: get()"
Cohesion: 0.11
...
### Community 148 - "Employee & Identity Management"
Cohesion: 0.10
Nodes (7): FixEmptyLocationCodesCommand, UserFactory, UserFactory, Illuminate\Database\Eloquent\Factories\Factory, Illuminate\Support\Str, Pdo\Mysql, static
...
### Community 150 - "Reporting & Form Engine"
Cohesion: 0.09
...
### Community 153 - "Admin Panel Filament Resources"
Cohesion: 0.12
Nodes (23): addPasteRules(), check(), checkAttrs(), endIndex(), Fw(), getObj(), hasProtocol(), render() (+15 more)

### Community 154 - "Reporting & Form Engine"
Cohesion: 0.10
Nodes (4): {closure#3}(), MandaysReport, BackedEnum, UnitEnum
...
### Community 157 - "Subsystem: sliceDoc()"
Cohesion: 0.14
Nodes (20): aO(), charCategorizer(), Fc(), getCursor(), getDeco(), gT(), highlight(), hT() (+12 more)
...
### Community 163 - "Reporting & Form Engine"
Cohesion: 0.12
Nodes (6): {closure#1}(), {closure#12}(), {closure#14}(), {closure#15}(), {closure#16}(), {closure#2}()
...
### Community 169 - "Attendance & Schedule Subsystem"
Cohesion: 0.15
...
### Community 171 - "Subsystem: destroy()"
Cohesion: 0.16
Nodes (16): atLastNode(), clear(), destroy(), ignore(), move(), NP(), prev(), scroll() (+8 more)

### Community 172 - "Subsystem: color-picker.js"
Cohesion: 0.13
Nodes (4): [g](), style(), update(), [x]()

### Community 173 - "Subsystem: fn()"
Cohesion: 0.26
Nodes (16): Ae(), Ce(), De(), fn(), Ft(), ht(), ii(), Le() (+8 more)

### Community 174 - "Subsystem: TestCase"
Cohesion: 0.16
...
### Community 175 - "Admin Panel Filament Resources"
Cohesion: 0.12
...
### Community 182 - "Attendance & Schedule Subsystem"
Cohesion: 0.14
Nodes (14): Doc: ROADMAP.md, Master Implementation Plan (Roadmap Lanjutan), ✅ Tahap 10: Penguncian Parameter Odoo Sync (NIK + , ✅ Tahap 11: Pengikatan Department ke Prinsiple & A, ✅ Tahap 1: Penyelarasan Antarmuka (UI Overhaul) & , ✅ Tahap 2: Manajemen Target HK & Payslip (SELESAI), ✅ Tahap 3: Laporan Sales (OOS, Plano, Promo) & Pem, ✅ Tahap 4: Laporan Tren Analitik (Web Admin) (SELE (+6 more)

### Community 183 - "Flutter Mobile UI Components"
Cohesion: 0.28
...
### Community 184 - "Subsystem: renderOptions()"
Cohesion: 0.37
...
### Community 185 - "Subsystem: e()"
Cohesion: 0.21
Nodes (13): A(), e(), ue(), vi(), c(), X(), a(), toggleFiltersDropdown() (+5 more)

### Community 186 - "Employee & Identity Management"
Cohesion: 0.15
...
### Community 187 - "Attendance & Schedule Subsystem"
Cohesion: 0.17
...
Cohesion: 0.18
Nodes (5): CreateProduct, Builder, UnitEnum, ProductResource, ProductForm
...
### Community 190 - "Subsystem: date-time-picker.js"
Cohesion: 0.29
...
### Community 194 - "Subsystem: Doc: SKILL.md"
Cohesion: 0.17
...
### Community 195 - "Attendance & Schedule Subsystem"
Cohesion: 0.17
...
### Community 196 - "Reporting & Form Engine"
Cohesion: 0.17
...
### Community 197 - "Flutter Mobile UI Components"
Cohesion: 0.20
Nodes (4): BranchResource, UnitEnum, CreateBranch, EditBranch

### Community 198 - "Attendance & Schedule Subsystem"
Cohesion: 0.24
Nodes (3): {closure#5}(), SalesReport, AIService

### Community 199 - "Subsystem: webpack.mix.js"
Cohesion: 0.18
Nodes (9): { EnvironmentPlugin }, glob, mix, path, sassOptions, ref_glob, laravel-mix, ref_path (+1 more)

### Community 200 - "Employee & Identity Management"
Cohesion: 0.18
...
### Community 201 - "Subsystem: Doc: SKILL.md"
Cohesion: 0.18
...
Cohesion: 0.27
Nodes (4): {closure#1}(), PermissionMatrix, RoleForm, Filament\Forms\Components\Field

### Community 205 - "Reporting & Form Engine"
Cohesion: 0.44
Nodes (7): {closure#150}(), {closure#151}(), {closure#153}(), {closure#156}(), {closure#161}(), {closure#165}(), {closure#169}()

### Community 206 - "Subsystem: _calcLatLngDistances()"
Cohesion: 0.22
...
### Community 209 - "Reporting & Form Engine"
Cohesion: 0.20
...
### Community 210 - "Admin Panel Filament Resources"
Cohesion: 0.20
...
### Community 211 - "Subsystem: Doc: implementation-playb"
Cohesion: 0.20
...
### Community 212 - "Subsystem: Doc: SKILL.md"
Cohesion: 0.20
...
### Community 213 - "Subsystem: Doc: SKILL.md"
Cohesion: 0.20
Nodes (10): Doc: SKILL.md, Behavioral Traits, Capabilities, Do not use this skill when, Example Interactions, Instructions, Knowledge Base, Purpose (+2 more)

### Community 214 - "Subsystem: Doc: PANDUAN_MIGRASI_SWIT"
Cohesion: 0.20
...
### Community 215 - "Odoo ERP & Principal Integration"
Cohesion: 0.20
...
### Community 217 - "Flutter Mobile UI Components"
Cohesion: 0.22
...
### Community 221 - "Employee & Identity Management"
Cohesion: 0.22
...
### Community 222 - "Subsystem: constants.dart"
Cohesion: 0.22
Nodes (8): baseUrl, Constants, defaultProductionUrl, getImageUrl, isProductionUrl, loadBaseUrl, setBaseUrl, static String
...
### Community 238 - "Odoo ERP & Principal Integration"
Cohesion: 0.29
Nodes (4): {closure#1}(), {closure#2}(), {closure#3}(), {closure#4}()
...
### Community 246 - "Admin Panel Filament Resources"
Cohesion: 0.29
...
### Community 247 - "Subsystem: Doc: implementation-playb"
Cohesion: 0.29
...
### Community 251 - "Odoo ERP & Principal Integration"
Cohesion: 0.29
...
### Community 254 - "Odoo ERP & Principal Integration"
Cohesion: 0.33
Nodes (3): {closure#1}(), {closure#2}(), {closure#3}()

### Community 255 - "Subsystem: 2026_08_13_100000_add_cut"
Cohesion: 0.33
Nodes (3): {closure#1}(), {closure#2}(), {closure#3}()
...
### Community 270 - "Subsystem: psr-4"
Cohesion: 0.40
Nodes (5): autoload, psr-4, App\\, Database\\Factories\\, Database\\Seeders\\

### Community 314 - "Reporting & Form Engine"
Cohesion: 0.40
Nodes (3): {closure#1}(), {closure#2}(), up()

### Community 317 - "Admin Panel Filament Resources"
Cohesion: 0.40
Nodes (3): {closure#1}(), {closure#2}(), up()

### Community 321 - "Subsystem: att-admin-v12/deploy.sh"
Cohesion: 0.70
Nodes (4): deploy_local_dev(), deploy_three_prod_servers(), setup_ssh_pairing(), deploy.sh script

### Community 322 - "Subsystem: main.js"
Cohesion: 0.40
Nodes (3): element(), isDarkStyle, isRtl

### Community 323 - "Employee & Identity Management"
Cohesion: 0.40
...
### Community 329 - "Subsystem: horizontalLayout.blade.ph"
Cohesion: 0.40
...
### Community 331 - "Subsystem: deploy.sh"
Cohesion: 0.70
Nodes (4): deploy_local_dev(), deploy_three_prod_servers(), setup_ssh_pairing(), deploy.sh script

### Community 332 - "Attendance & Schedule Subsystem"
Cohesion: 0.40
...
### Community 389 - "Reporting & Form Engine"
Cohesion: 0.50
...
### Community 391 - "Subsystem: extra"
Cohesion: 0.67
Nodes (3): extra, laravel, dont-discover

### Community 392 - "Subsystem: pt()"
Cohesion: 0.67
Nodes (3): H(), ji(), pt()

### Community 453 - "Subsystem: Doc: implementation-playb"
Cohesion: 0.67
Nodes (3): Doc: implementation-playbook.md, Dependency Audit and Security Analysis Implementat, Instructions

### Community 454 - "Subsystem: Doc: README.md"
Cohesion: 0.67
Nodes (3): Doc: README.md, Getting Started, att_mobile

### Community 455 - "Attendance & Schedule Subsystem"
Cohesion: 0.67
...
- **2141 isolated node(s):** `SortDirection`, `$schema`, `name`, `type`, `description` (+2136 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 5421 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **591 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `BlastInfo` connect `Attendance & Schedule Subsystem` to `Employee & Identity Management`, `Flutter Mobile UI Components`, `Employee & Identity Management`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `Controller` connect `API & Mobile State Providers` to `Employee & Identity Management`, `Odoo ERP & Principal Integration`, `Attendance & Schedule Subsystem`, `Attendance & Schedule Subsystem`, `Employee & Identity Management`, `Subsystem: Chat.php`, `Subsystem: InvoiceEdit.php`, `Attendance & Schedule Subsystem`, `Subsystem: InvoiceList.php`, `Flutter Mobile UI Components`, `Employee & Identity Management`, `Employee & Identity Management`, `Subsystem: ForgotPasswordBasic.php`, `Employee & Identity Management`, `Subsystem: RegisterBasic.php`, `Subsystem: RegisterMultiSteps.php`, `Subsystem: ResetPasswordBasic.php`, `Subsystem: ResetPasswordCover.php`, `Subsystem: TwoStepsCover.php`, `Flutter Mobile UI Components`, `Subsystem: Avatar.php`, `Subsystem: BlockUI.php`, `Subsystem: PerfectScrollbar.php`, `Subsystem: Tour.php`, `Subsystem: BasicInput.php`, `Subsystem: Picker.php`, `Odoo ERP & Principal Integration`, `Employee & Identity Management`, `Subsystem: Sliders.php`, `Subsystem: Switches.php`, `Admin Panel Filament Resources`, `Subsystem: StickyActions.php`, `Admin Panel Filament Resources`, `Subsystem: Blank.php`, `Subsystem: CollapsedMenu.php`, `Subsystem: ContentNavbar.php`, `Subsystem: Vertical.php`, `Subsystem: WithoutMenu.php`, `Subsystem: AccountSettingsAccount.ph`, `Subsystem: AccountSettingsBilling.ph`, `Subsystem: AccountSettingsConnection`, `Subsystem: HelpCenterArticle.php`, `Employee & Identity Management`, `Admin Panel Filament Resources`, `Subsystem: Collapse.php`, `Subsystem: ListGroups.php`, `Subsystem: Navbar.php`, `Subsystem: Offcanvas.php`, `Subsystem: TabsPills.php`, `Subsystem: Toasts.php`, `Employee & Identity Management`, `API & Mobile State Providers`, `Attendance & Schedule Subsystem`, `Reporting & Form Engine`, `API & Mobile State Providers`, `Flutter Mobile UI Components`, `Visit & Itinerary Management`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `Principal` connect `Odoo ERP & Principal Integration` to `Odoo ERP & Principal Integration`, `Attendance & Schedule Subsystem`, `Attendance & Schedule Subsystem`, `Attendance & Schedule Subsystem`, `Attendance & Schedule Subsystem`, `Attendance & Schedule Subsystem`, `Attendance & Schedule Subsystem`, `Reporting & Form Engine`, `Attendance & Schedule Subsystem`, `Odoo ERP & Principal Integration`, `Attendance & Schedule Subsystem`, `Visit & Itinerary Management`, `Reporting & Form Engine`, `Odoo ERP & Principal Integration`, `Admin Panel Filament Resources`, `Odoo ERP & Principal Integration`, `Reporting & Form Engine`, `Odoo ERP & Principal Integration`, `API & Mobile State Providers`, `Attendance & Schedule Subsystem`, `Subsystem: att-admin-v12/routes/web.`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
...
- **Should `Employee & Identity Management` be split into smaller, more focused modules?**
  _Cohesion score 0.008856528496306231 - nodes in this community are weakly interconnected._
- **Should `Odoo ERP & Principal Integration` be split into smaller, more focused modules?**
  _Cohesion score 0.014949839354796407 - nodes in this community are weakly interconnected._
- **Should `Subsystem: rich-editor.js` be split into smaller, more focused modules?**
  _Cohesion score 0.012724014336917562 - nodes in this community are weakly interconnected._