...
## Corpus Check
- Large corpus: 1437 files · ~4,644,892 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.
...
- `{closure#12}()` --calls--> `AttendanceImportTemplateExport`  [INFERRED]
  att-admin-v12/app/Filament/Resources/Attendances/Tables/AttendancesTable.php → att-admin-v12/app/Exports/AttendanceImportTemplateExport.php
...
- `Email` --inherits--> `Controller`  [EXTRACTED]
  att-admindashboard/app/Http/Controllers/apps/Email.php → att-admin-v12/app/Http/Controllers/Controller.php
...
Cohesion: 0.01
Nodes (231): {closure#1}(), {closure#2}(), {closure#3}(), {closure#1}(), {closure#2}(), {closure#1}(), {closure#2}(), {closure#3}() (+223 more)

### Community 1 - "Employee & Identity Management"
Cohesion: 0.01
Nodes (114): Ac(), addCompletion(), addCompletions(), addEventListener(), addNamespace(), addNamespaceObject(), addSelection(), addWindowListeners() (+106 more)

### Community 2 - "Subsystem: rich-editor.js"
Cohesion: 0.01
Nodes (174): $0(), Ab(), ac(), accepts(), addAttributes(), addHackNode(), addNode(), addNodeMark() (+166 more)

### Community 4 - "Reporting & Form Engine"
Cohesion: 0.01
...
### Community 5 - "API & Mobile State Providers"
Cohesion: 0.01
...
Cohesion: 0.01
Nodes (74): Controller, AccessPermission, AccessRoles, Calendar, Chat, InvoiceAdd, InvoiceEdit, InvoiceList (+66 more)

### Community 7 - "Odoo ERP & Principal Integration"
Cohesion: 0.02
Nodes (74): CheckDuluxProductsCommand, LinkPrincipalsCommand, Principal, ReportFormField, Carbon, ReportTemplate, {closure#1}(), {closure#2}() (+66 more)

### Community 8 - "Odoo ERP & Principal Integration"
Cohesion: 0.02
Nodes (52): CheckPrincipalsCommand, CleanDuluxWorkLocationsCommand, CreateDuluxDummyEmployeesCommand, DbLocksCommand, FixEmptyLocationCodesCommand, FixOrphanedEmployeeDataCommand, ImportAreasCommand, ImportDuluxAmkStoresCommand (+44 more)
...
Cohesion: 0.02
Nodes (80): AreaForm, {closure#1}(), {closure#2}(), AttendanceForm, {closure#2}(), CompetitorProductForm, {closure#3}(), {closure#1}() (+72 more)

### Community 11 - "Attendance & Schedule Subsystem"
Cohesion: 0.02
Nodes (66): App\Filament\Resources\WorkingGroupResource\Pages, AreasTable, AttendanceBapsTable, AttendancesTable, BranchForm, BranchesTable, CompanyResource, UnitEnum (+58 more)

### Community 12 - "API & Mobile State Providers"
Cohesion: 0.01
...
### Community 13 - "Admin Panel Filament Resources"
Cohesion: 0.02
...
Cohesion: 0.03
Nodes (31): {closure#6}(), {closure#9}(), BlastInfo, CompetitorProduct, Holiday, ItineraryItem, MeetingParticipant, Payslip (+23 more)

### Community 16 - "Subsystem: resolve()"
Cohesion: 0.05
Nodes (147): ad(), addKeyboardShortcuts(), after(), am(), as(), au(), Ay(), bc() (+139 more)
...
Cohesion: 0.02
Nodes (30): {closure#1}(), {closure#2}(), {closure#20}(), {closure#3}(), {closure#6}(), {closure#7}(), {closure#8}(), {closure#11}() (+22 more)

### Community 19 - "Attendance & Schedule Subsystem"
Cohesion: 0.02
Nodes (46): EmployeeScheduleTemplateExport, ShiftImporter, {closure#5}(), {closure#11}(), {closure#11}(), {closure#12}(), {closure#14}(), {closure#15}() (+38 more)

### Community 20 - "Employee & Identity Management"
Cohesion: 0.03
Nodes (124): aa(), acceptToken(), allows(), AQ(), au(), AX(), b1(), Bg() (+116 more)

### Community 21 - "Attendance & Schedule Subsystem"
Cohesion: 0.03
Nodes (31): App\Filament\Resources\PayslipResource\Pages, App\Filament\Resources\VisitReportResource\Pages, App\Filament\Resources\WorkTargetResource\Pages, {closure#10}(), {closure#15}(), {closure#16}(), {closure#1}(), {closure#12}() (+23 more)

### Community 22 - "Subsystem: .slice()"
Cohesion: 0.05
Nodes (117): addCommands(), addInputRules(), addMark(), addProseMirrorPlugins(), ak(), Ap(), apply(), applyInner() (+109 more)
...
Cohesion: 0.04
Nodes (108): _a(), addGlobalAttributes(), addNodeView(), af(), c(), d(), atEnd(), atStart() (+100 more)
...
### Community 27 - "Subsystem: markdown-editor.js"
Cohesion: 0.04
Nodes (96): Aa(), ad(), af(), ai(), An(), ao(), Ba(), bf() (+88 more)

### Community 28 - "Subsystem: _update()"
Cohesion: 0.04
...
### Community 30 - "Admin Panel Filament Resources"
Cohesion: 0.04
Nodes (99): ac(), ae(), after(), ag(), Al(), Am(), before(), bl() (+91 more)

### Community 31 - "Employee & Identity Management"
Cohesion: 0.06
...
### Community 32 - "Flutter Mobile UI Components"
Cohesion: 0.04
Nodes (97): add(), addToSet(), applyEdits(), B(), bf(), buildDeco(), childString(), configure() (+89 more)

### Community 33 - "Attendance & Schedule Subsystem"
Cohesion: 0.03
Nodes (29): EditArea, EditAttendance, EditBlastInfo, EditBranch, EditCompany, EditCompetitorProduct, EditDepartment, EditEmployee (+21 more)

### Community 34 - "Subsystem: flush()"
Cohesion: 0.04
Nodes (95): add(), ag(), Ar(), Bd(), cg(), connectSelection(), coordsAtPos(), $d() (+87 more)
...
### Community 38 - "Flutter Mobile UI Components"
Cohesion: 0.04
...
### Community 39 - "Subsystem: n()"
Cohesion: 0.07
Nodes (86): _a(), Ae(), ar(), as(), bc(), u(), ci(), r() (+78 more)
...
Cohesion: 0.04
Nodes (82): addChunk(), addInfoPane(), addInner(), adjust(), annotation(), atLastNode(), bS(), Cf() (+74 more)

### Community 42 - "Subsystem: __fire()"
Cohesion: 0.05
...
### Community 43 - "Reporting & Form Engine"
Cohesion: 0.03
...
Cohesion: 0.04
Nodes (20): {closure#3}(), User, {closure#1}(), {closure#3}(), up(), PermissionsSeeder, UserManagement, User (+12 more)

### Community 45 - "Admin Panel Filament Resources"
Cohesion: 0.04
...
### Community 46 - "Attendance & Schedule Subsystem"
Cohesion: 0.04
Nodes (31): AreaResource, CreateArea, CreateAttendance, CreateBlastInfo, CreateBranch, CreateCompany, CompetitorProductResource, UnitEnum (+23 more)

### Community 47 - "Attendance & Schedule Subsystem"
Cohesion: 0.03
Nodes (15): up(), up(), {closure#1}(), {closure#2}(), {closure#1}(), {closure#3}(), {closure#1}(), {closure#2}() (+7 more)

### Community 48 - "Subsystem: advance()"
Cohesion: 0.04
Nodes (72): addChild(), addGaps(), addLeafElement(), addNode(), advance(), ATXHeading(), balance(), blank() (+64 more)
...
Cohesion: 0.04
Nodes (39): {closure#10}(), {closure#12}(), {closure#2}(), {closure#3}(), {closure#4}(), {closure#5}(), {closure#6}(), {closure#7}() (+31 more)

### Community 51 - "Subsystem: find()"
Cohesion: 0.04
Nodes (66): activateHover(), baseDirAt(), bd(), Bh(), bidiIn(), bidiSpans(), bidiSpansAt(), bP() (+58 more)

### Community 52 - "Subsystem: file-upload.js"
Cohesion: 0.05
Nodes (51): am(), Ap(), be(), bi(), Bp(), c(), clickPercent(), cm() (+43 more)

### Community 53 - "Visit & Itinerary Management"
Cohesion: 0.03
...
### Community 56 - "Attendance & Schedule Subsystem"
Cohesion: 0.07
Nodes (20): AttendanceImportTemplateExport, AttendanceRosterMatrixExport, EmployeeScheduleMatrixTemplateExport, EmployeeScheduleRangeTemplateExport, MandaysExport, ManPowerExport, ShiftTemplateExport, TeamUncheckedExport (+12 more)
...
### Community 60 - "Subsystem: facet()"
Cohesion: 0.05
Nodes (61): accept(), active(), Ah(), applyTransaction(), asSingle(), blur(), build(), cP() (+53 more)

### Community 61 - "Subsystem: constructor()"
Cohesion: 0.04
Nodes (60): af(), alpha(), Bc(), Be(), bg(), $c(), chartOptionScopes(), color() (+52 more)

### Community 62 - "Odoo ERP & Principal Integration"
Cohesion: 0.04
...
### Community 63 - "Attendance & Schedule Subsystem"
Cohesion: 0.06
...
### Community 65 - "Subsystem: y()"
Cohesion: 0.14
Nodes (59): Dg(), Ig(), Se(), al(), at(), Be(), Cr(), Ct() (+51 more)
...
### Community 71 - "Subsystem: s()"
Cohesion: 0.06
Nodes (55): Eo(), aa(), ac(), addEventListener(), al(), ba(), bindResponsiveEvents(), bs() (+47 more)

### Community 72 - "Subsystem: nodesBetween()"
Cohesion: 0.06
Nodes (53): addStoredMark(), append(), Bo(), childAfter(), childBefore(), Cn(), Cu(), dc() (+45 more)
...
### Community 74 - "Subsystem: columns/select.js"
Cohesion: 0.08
Nodes (43): Ae(), Ai(), An(), applyDisabledState(), be(), Bt(), De(), disable() (+35 more)

### Community 75 - "Odoo ERP & Principal Integration"
Cohesion: 0.06
...
### Community 77 - "Subsystem: of()"
Cohesion: 0.05
Nodes (50): baseTheme(), between(), bu(), cO(), define(), domEventHandlers(), domEventObservers(), dr() (+42 more)

### Community 78 - "Subsystem: te()"
Cohesion: 0.05
...
### Community 80 - "Attendance & Schedule Subsystem"
Cohesion: 0.05
Nodes (14): AttendanceBapResource, UnitEnum, CreateAttendanceBap, EditAttendanceBap, ViewAttendanceBap, AttendanceBapForm, ViewLeaveRequest, ViewLocationRequest (+6 more)
...
Cohesion: 0.05
Nodes (11): {closure#1}(), BelongsToMany, Product, ReportSubmissionValue, up(), up(), up(), up() (+3 more)

### Community 83 - "Flutter Mobile UI Components"
Cohesion: 0.05
Nodes (51): addExtensions(), applyInitialSize(), Cc(), configure(), constructor(), createCommandManager(), createContainer(), createDoc() (+43 more)

### Community 84 - "Admin Panel Filament Resources"
Cohesion: 0.07
Nodes (51): Ar(), average(), buildOrUpdateScales(), D(), dc(), determineDataLimits(), dh(), diff() (+43 more)

### Community 85 - "Subsystem: getContext()"
Cohesion: 0.07
...
### Community 91 - "Flutter Mobile UI Components"
Cohesion: 0.05
Nodes (18): App\Filament\Resources\BlastInfoResource\Pages, App\Filament\Resources\LeaveRequestResource\Pages, BlastInfoResource, {closure#3}(), {closure#4}(), Schema, UnitEnum, {closure#1}() (+10 more)

### Community 92 - "Attendance & Schedule Subsystem"
Cohesion: 0.04
...
### Community 93 - "Subsystem: forward()"
Cohesion: 0.06
Nodes (47): addActive(), addChanges(), Ar(), as(), be(), changeByRange(), changes(), chunkEnd() (+39 more)

### Community 94 - "Subsystem: ir()"
Cohesion: 0.10
Nodes (45): Ae(), Bt(), Ft(), ir(), at(), be(), ce(), Ct() (+37 more)
...
Cohesion: 0.06
Nodes (46): aO(), charCategorizer(), cS(), d0(), De(), E$(), f0(), Fc() (+38 more)
...
### Community 99 - "Reporting & Form Engine"
Cohesion: 0.09
...
### Community 100 - "Visit & Itinerary Management"
Cohesion: 0.05
...
### Community 101 - "Flutter Mobile UI Components"
Cohesion: 0.05
Nodes (5): ViewTrackingHistory, CreateWorkingGroup, EditWorkingGroup, Filament\Resources\Pages\Concerns\InteractsWithRecord, Filament\Resources\Pages\Page

### Community 102 - "Subsystem: components/select.js"
Cohesion: 0.10
Nodes (33): Ae(), An(), be(), Bt(), Ce(), De(), ei(), en() (+25 more)
...
Cohesion: 0.05
Nodes (14): EmployeeForm, ListEmployeeSchedules, LeaveRequestResource, Builder, UnitEnum, LocationRequestForm, PayslipResource, Builder (+6 more)

### Community 106 - "Subsystem: Si()"
Cohesion: 0.14
Nodes (41): At(), b(), bi(), bn(), ci(), cn(), ct(), di() (+33 more)

### Community 107 - "Subsystem: slider.js"
Cohesion: 0.10
Nodes (38): We(), ar(), Be(), Ce(), De(), _e(), Ee(), er() (+30 more)
...
### Community 116 - "Flutter Mobile UI Components"
Cohesion: 0.07
Nodes (15): LocationRequestResource, Builder, UnitEnum, {closure#10}(), {closure#11}(), {closure#12}(), {closure#13}(), {closure#14}() (+7 more)

### Community 117 - "Flutter Mobile UI Components"
Cohesion: 0.06
Nodes (35): PermitProvider, build, createState, _cutiTypes, _endDate, _formKey, _imageFile, initState (+27 more)

### Community 118 - "API & Mobile State Providers"
Cohesion: 0.06
...
### Community 119 - "Admin Panel Filament Resources"
Cohesion: 0.08
Nodes (36): addAll(), _adjustAllMarkers(), _adjustRectangleForMarkerMove(), an(), clone(), enableRotate(), _findCorners(), _fireRotation() (+28 more)

### Community 120 - "Subsystem: lineAt()"
Cohesion: 0.08
Nodes (36): addBlock(), addLineDeco(), applyChanges(), balanced(), baseIndent(), baseIndentFor(), blankContent(), blockAt() (+28 more)

### Community 121 - "Subsystem: getDatasetMeta()"
Cohesion: 0.08
Nodes (36): themeClasses(), afterDatasetsUpdate(), bc(), beforeLayout(), fc(), gc(), generateLabels(), getDatasetMeta() (+28 more)

### Community 122 - "Reporting & Form Engine"
Cohesion: 0.09
...
### Community 123 - "Odoo ERP & Principal Integration"
Cohesion: 0.07
...
Cohesion: 0.09
Nodes (35): a$(), activeForPoint(), boundChange(), commit(), compare(), comparePoint(), compareRange(), Ds() (+27 more)

### Community 127 - "Employee & Identity Management"
Cohesion: 0.06
...
### Community 128 - "Subsystem: ye()"
Cohesion: 0.12
Nodes (34): Ac(), bl(), cd(), ee(), ue(), ce(), cl(), Dc() (+26 more)
...
### Community 130 - "Subsystem: i()"
Cohesion: 0.09
Nodes (33): addElement(), al(), compute(), i(), createParse(), cX(), f(), h() (+25 more)

### Community 131 - "Subsystem: Ue()"
Cohesion: 0.11
...
### Community 133 - "Flutter Mobile UI Components"
Cohesion: 0.06
...
### Community 135 - "Subsystem: Ew()"
Cohesion: 0.08
Nodes (18): Pi(), [g](), style(), update(), [x](), Fr(), Kc(), ki() (+10 more)

### Community 136 - "Subsystem: addElementByRule()"
Cohesion: 0.12
...
### Community 141 - "Subsystem: _updateHiddenPolyCircle()"
Cohesion: 0.11
...
### Community 144 - "Visit & Itinerary Management"
Cohesion: 0.09
Nodes (6): ItineraryResource, Builder, UnitEnum, CreateItinerary, ListItineraries, {closure#9}()

### Community 145 - "Admin Panel Filament Resources"
Cohesion: 0.12
Nodes (22): B(), close(), E(), F(), G(), I(), L(), N() (+14 more)

### Community 146 - "Subsystem: T()"
Cohesion: 0.11
...
### Community 154 - "Attendance & Schedule Subsystem"
Cohesion: 0.16
Nodes (10): Maatwebsite\Excel\Concerns\WithColumnFormatting, PhpOffice\PhpSpreadsheet\Cell\Coordinate, PhpOffice\PhpSpreadsheet\Cell\DataType, PhpOffice\PhpSpreadsheet\Spreadsheet, PhpOffice\PhpSpreadsheet\Style\Alignment, PhpOffice\PhpSpreadsheet\Style\Border, PhpOffice\PhpSpreadsheet\Style\Fill, PhpOffice\PhpSpreadsheet\Style\Font (+2 more)

### Community 155 - "API & Mobile State Providers"
Cohesion: 0.10
Nodes (4): PermitController, SalesPipelineController, EmployeeLeaveQuota, Illuminate\Support\Facades\Validator
...
Cohesion: 0.11
Nodes (8): {closure#1}(), PermissionMatrix, CreateRole, EditRole, UnitEnum, RoleResource, RoleForm, Filament\Forms\Components\Field

### Community 158 - "API & Mobile State Providers"
Cohesion: 0.15
Nodes (20): addInner(), bu(), dy(), findIndex(), forChild(), from(), fu(), isColSelection() (+12 more)

### Community 159 - "Employee & Identity Management"
Cohesion: 0.18
Nodes (5): LiveChat, BackedEnum, UnitEnum, Width, ChatMessage

### Community 160 - "Flutter Mobile UI Components"
Cohesion: 0.12
Nodes (6): MeetingResource, UnitEnum, CreateMeeting, EditMeeting, ViewMeeting, MeetingForm
...
### Community 166 - "API & Mobile State Providers"
Cohesion: 0.16
...
### Community 176 - "Subsystem: ot()"
Cohesion: 0.17
Nodes (16): dd(), gl(), jl(), kn(), lr(), nd(), n(), od() (+8 more)
...
### Community 194 - "Subsystem: ResetPasswordMail"
Cohesion: 0.21
...
### Community 195 - "Admin Panel Filament Resources"
Cohesion: 0.17
Nodes (11): autoload-dev, psr-4, description, keywords, license, minimum-stability, name, prefer-stable (+3 more)

### Community 196 - "Subsystem: date-time-picker.js"
Cohesion: 0.29
Nodes (7): d(), e(), i(), m(), r(), s(), t()

### Community 199 - "Admin Panel Filament Resources"
Cohesion: 0.17
...
### Community 200 - "Subsystem: Doc: SKILL.md"
Cohesion: 0.17
...
### Community 201 - "Attendance & Schedule Subsystem"
Cohesion: 0.17
...
### Community 202 - "Reporting & Form Engine"
Cohesion: 0.17
...
### Community 208 - "Subsystem: MessageSent"
Cohesion: 0.29
...
### Community 210 - "Subsystem: _calcLatLngDistances()"
Cohesion: 0.22
...
### Community 211 - "Subsystem: Fe()"
Cohesion: 0.20
Nodes (10): Ce(), De(), Dt(), Fe(), He(), ir(), Mt(), nr() (+2 more)

### Community 212 - "Attendance & Schedule Subsystem"
Cohesion: 0.20
...
### Community 213 - "Reporting & Form Engine"
Cohesion: 0.20
...
### Community 214 - "Admin Panel Filament Resources"
Cohesion: 0.20
...
### Community 215 - "Subsystem: Doc: implementation-playb"
Cohesion: 0.20
...
### Community 217 - "Subsystem: Doc: SKILL.md"
Cohesion: 0.20
Nodes (10): Doc: SKILL.md, Behavioral Traits, Capabilities, Do not use this skill when, Example Interactions, Instructions, Knowledge Base, Purpose (+2 more)

### Community 218 - "Subsystem: Doc: PANDUAN_MIGRASI_SWIT"
Cohesion: 0.20
...
### Community 219 - "Odoo ERP & Principal Integration"
Cohesion: 0.20
...
### Community 220 - "Reporting & Form Engine"
Cohesion: 0.20
...
### Community 221 - "Flutter Mobile UI Components"
Cohesion: 0.22
Nodes (3): Builder, UnitEnum, WorkTargetResource

### Community 224 - "Subsystem: PermitStatusUpdated"
Cohesion: 0.31
...
### Community 225 - "Subsystem: att-admin-v12/bootstrap/a"
Cohesion: 0.28
...
### Community 226 - "Subsystem: scripts"
Cohesion: 0.22
Nodes (9): scripts, dev, post-autoload-dump, post-create-project-cmd, post-root-package-install, post-update-cmd, pre-package-uninstall, setup (+1 more)

### Community 227 - "Subsystem: X()"
Cohesion: 0.28
Nodes (9): A(), e(), Q(), ue(), vi(), c(), w(), X() (+1 more)

### Community 229 - "API & Mobile State Providers"
Cohesion: 0.28
...
### Community 230 - "Employee & Identity Management"
Cohesion: 0.22
...
### Community 231 - "Admin Panel Filament Resources"
Cohesion: 0.22
...
### Community 239 - "Subsystem: scripts"
Cohesion: 0.25
Nodes (8): scripts, dev, development, hot, prod, production, watch, watch-poll

### Community 241 - "Subsystem: Doc: README.md"
Cohesion: 0.25
...
### Community 242 - "Subsystem: Doc: README.md"
Cohesion: 0.25
...
### Community 243 - "Attendance & Schedule Subsystem"
Cohesion: 0.29
Nodes (3): AttendanceResource, Builder, UnitEnum

### Community 245 - "API & Mobile State Providers"
Cohesion: 0.29
...
### Community 251 - "Admin Panel Filament Resources"
Cohesion: 0.29
...
### Community 252 - "Subsystem: Doc: implementation-playb"
Cohesion: 0.29
...
### Community 255 - "Attendance & Schedule Subsystem"
Cohesion: 0.29
...
### Community 256 - "Odoo ERP & Principal Integration"
Cohesion: 0.29
...
### Community 259 - "Subsystem: att-admin-v12/config/logg"
Cohesion: 0.47
...
### Community 280 - "Subsystem: horizontalLayout.blade.ph"
Cohesion: 0.40
...
### Community 282 - "Subsystem: deploy.sh"
Cohesion: 0.70
Nodes (4): deploy_local_dev(), deploy_three_prod_servers(), setup_ssh_pairing(), deploy.sh script

### Community 283 - "Attendance & Schedule Subsystem"
Cohesion: 0.40
...
### Community 290 - "Subsystem: app-calendar-events.js"
Cohesion: 0.50
...
### Community 293 - "Subsystem: app-invoice-edit.blade.ph"
Cohesion: 0.50
...
### Community 299 - "Reporting & Form Engine"
Cohesion: 0.50
...
### Community 301 - "Subsystem: extra"
Cohesion: 0.67
Nodes (3): extra, laravel, dont-discover

### Community 302 - "Subsystem: pt()"
Cohesion: 0.67
Nodes (3): H(), ji(), pt()

### Community 373 - "Subsystem: Doc: implementation-playb"
Cohesion: 0.67
Nodes (3): Doc: implementation-playbook.md, Dependency Audit and Security Analysis Implementat, Instructions

### Community 374 - "Subsystem: Doc: README.md"
Cohesion: 0.67
Nodes (3): Doc: README.md, Getting Started, att_mobile

### Community 375 - "Attendance & Schedule Subsystem"
Cohesion: 0.67
...
- **Should `Employee & Identity Management` be split into smaller, more focused modules?**
  _Cohesion score 0.005687179487179487 - nodes in this community are weakly interconnected._
- **Should `Employee & Identity Management` be split into smaller, more focused modules?**
  _Cohesion score 0.009122144792876501 - nodes in this community are weakly interconnected._
- **Should `Subsystem: rich-editor.js` be split into smaller, more focused modules?**
  _Cohesion score 0.01117944512778461 - nodes in this community are weakly interconnected._