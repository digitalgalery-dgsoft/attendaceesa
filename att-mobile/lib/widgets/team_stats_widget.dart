...
class TeamStatsWidget extends StatelessWidget {
        ...
        children: [
          ...
          GridView.count(
            ...
            children: [
              ...
              _buildGridCard('Vacant (Kosong)', dashboardProvider.vacant.toString(), Icons.warning, Colors.redAccent, cardColor, textColor),
            ],
          ),
          const SizedBox(height: 12),
          Card(
  ...
  Widget _buildGridCard(String title, String value, IconData icon, Color color, Color cardColor, Color textColor) {
    return Card(
      color: cardColor,
      elevation: 2,
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
